...
public class ModEntityRegistry {
	...
	public static void registerEntities()
	{
		...
		createEntity(EntityTiger.class, "[FlansMod] Panzer VI Tiger (Official Pack)");
		...
		createEntity(EntityTiger131.class, "[FlansMod] Panzer VI Tiger 131 (Official Pack)");
		createEntity(EntityTigerII.class, "[FlansMod] Panzer VI Tiger II (Official Pack)");
		...
		createEntity(EntityTigerIE.class, "[FlansMod] Panzer VI Tiger Ausf. E (Manus Pack)");
		createEntity(EntityTigerIIB.class, "[FlansMod] Panzer VI Tiger II Ausf. B (Manus Pack)");
		...
		createEntity(EntityTiger1E.class, "[FlansMod] Panzer VI Tiger Ausf. E (Extra Zero 8)");
		...
		createEntity(EntityBF109E3.class, "[FlansMod] BF-109 E3");
		createEntity(EntityBF109G10.class, "[FlansMod] BF-109 G10");
		...
		createEntity(EntityKubel.class, "[FlansMod] Kuebelwagen (Official Pack)");
		...
		createEntity(EntityPak40.class, "[FlansMod] 75mm PaK 40 (Official Pack)");
		...
		createEntity(EntitySentryGun.class, "[FlansMod] Sentry Gun (Official Pack)");

		createEntity(EntitySdkFz2.class, "[FlansMod] SdKfz 2 Kettenkrad (Official Pack)");
		createEntity(EntitySdkFz222.class, "[FlansMod] SdKfz 222 (Official Pack)");
		createEntity(EntitySdkFz251.class, "[FlansMod] SdKfz 251 (Official Pack)");
		createEntity(EntityBoxer1.class, "[FlansMod] GTK Boxer (Manus Pack)");
		createEntity(EntityBoxer2.class, "[FlansMod] GTK Boxer with HK Grenade Machine Gun (Manus Pack)");
		createEntity(EntityBoxer3.class, "[FlansMod] GTK Boxer with Cal. 50 Gun (Manus Pack)");
		createEntity(EntityBoxer4.class, "[FlansMod] GTK Boxer with with 20mm Cannon (Manus Pack)");
		createEntity(EntityBoxer5.class, "[FlansMod] GTK Boxer with Skyranger AD (Manus Pack)");
		createEntity(EntityBwTruck.class, "[FlansMod] German Bundeswehr Truck (Manus Pack)");
		createEntity(EntityHMMWV1.class, "[FlansMod] M998 HMMWV (Manus Pack)");
		createEntity(EntityHMMWV2.class, "[FlansMod] M998 HMMWV with open load area (Manus Pack)");
		createEntity(EntityHMMWV3.class, "[FlansMod] M998 HMMWV with Cal. 50 Gun (Manus Pack)");
		createEntity(EntityHMMWV4.class, "[FlansMod] M998 HMMWV with M134(Manus Pack)");
		createEntity(EntityLeopardIIA6.class, "[FlansMod] Leopard 2 A6 (Manus Pack)");
		createEntity(EntityLeopard2A7.class, "[FlansMod] Leopard 2 A7+ PSO (Manus Pack)");

		// WIP
		//createEntity(EntityMark3.class, "[FlansMod] Mark 3"); //TODO: add a texture
	}
