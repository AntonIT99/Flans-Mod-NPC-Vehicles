...
{
    private static final ResourceLocation Texture = new ResourceLocation(Strings.MOD_ID + ":textures/entity/Tiger/Tiger.png");
    ...
    {
        return this.getEntityTexture((EntityTiger)par1Entity);
    }
}