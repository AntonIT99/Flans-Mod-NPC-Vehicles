...
import com.wolffsmod.entity.EntitySlava;
...
{
    private static final ResourceLocation Texture = new ResourceLocation(Strings.MODID + ":textures/entity/Slava/Slava.png");
