...
import com.wolffsmod.entity.EntityMilitaryCrate;
...
public class RenderMilitaryCrate extends RenderLiving
{
    ...
    protected ResourceLocation getEntityTexture(EntityMilitaryCrate par1Entity)
    {
        return Texture;
    }
    ...
    {
        return this.getEntityTexture((EntityMilitaryCrate)par1Entity);
    }
}
