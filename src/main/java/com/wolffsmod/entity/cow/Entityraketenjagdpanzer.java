...
public class Entityraketenjagdpanzer extends EntityFlanVehicleNPC
{
    public Entityraketenjagdpanzer(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
