package com.wolffsmod.entity.aoba;

import com.wolffsmod.entity.EntityFlanVehicleNPC;

import net.minecraft.world.World;

public class EntityT95 extends EntityFlanVehicleNPC
{
    public EntityT95(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.3F);
        setDriver("28 2 16 -10 11 -5 20");
        setPassenger("1 -58 31 16 core -160 160 -8 45 twelveMM Browning");
        setPassengerAimSpeed("1 4 4 0");
        addShootPointPrimary("128 18 0 turret");
        addGunOrigin("1 -58 12 16");
