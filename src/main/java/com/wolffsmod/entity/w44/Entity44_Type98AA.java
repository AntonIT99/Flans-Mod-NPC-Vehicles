...
public class Entity44_Type98AA extends EntityFlanVehicleNPC
{
    public Entity44_Type98AA(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.0F);
        setDriver("0 1 0 -360 360 -5 85");
        setRotatedDriverOffset("-20 0 -5");
        setDriverAimSpeed("1.35f 1.25f 0f");
        addBarrelPosition("22 7 0");
