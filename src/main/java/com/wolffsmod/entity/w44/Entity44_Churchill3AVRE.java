...
public class Entity44_Churchill3AVRE extends EntityFlanVehicleNPC
{
    public Entity44_Churchill3AVRE(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.23F);
        setDriver("0 32 0 -18 18 -4 15");
        setRotatedDriverOffset("-6 0 -10");
        setDriverAimSpeed("1.13 1.03 0");
        setPassenger("1 38 1 6 core -10 10 -10 10 44_Bren PassengerGun1");
        addBarrelPosition("40 31 0");
        addGun("28 33 -5 turret 44_Bren");
        addGunOrigin("1 120 -1 -8");
        ...
        addLeftLinkPoint("[66,20,21]");
        addLeftLinkPoint("[70,16,21]");
        addLeftLinkPoint("[70,9.5,21]");
        addLeftLinkPoint("[54,-3,21]");
        addLeftLinkPoint("[42,-9,21]");
        addLeftLinkPoint("[-40,-9,21]");
        addLeftLinkPoint("[-51,-4,21]");
        addLeftLinkPoint("[-68,10,21]");
        addLeftLinkPoint("[-68,15,21]");
        addLeftLinkPoint("[-63,17,21]");
        addLeftLinkPoint("[-36,20,21]");
        addLeftLinkPoint("[60,20,21]");
        addRightLinkPoint("[66,20,-21]");
        addRightLinkPoint("[70,16,-21]");
        addRightLinkPoint("[70,9.5,-21]");
        addRightLinkPoint("[54,-3,-21]");
        addRightLinkPoint("[42,-9,-21]");
        addRightLinkPoint("[-45,-9,-21]");
        addRightLinkPoint("[-51,-4,-21]");
        addRightLinkPoint("[-68,10,-21]");
        addRightLinkPoint("[-68,15,-21]");
        addRightLinkPoint("[-63,17,-21]");
        addRightLinkPoint("[-36,20,-21]");
        addRightLinkPoint("[60,20,-21]");
