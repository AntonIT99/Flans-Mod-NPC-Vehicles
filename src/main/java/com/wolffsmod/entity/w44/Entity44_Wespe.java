...
public class Entity44_Wespe extends EntityFlanVehicleNPC
{
    public Entity44_Wespe(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        addLeftLinkPoint("[51,11,18.5]");
        addLeftLinkPoint("[54.3,10,18.5]");
        addLeftLinkPoint("[54.3,3,18.5]");
        addLeftLinkPoint("[42,-9,18.5]");
        addLeftLinkPoint("[-18,-9,18.5]");
        addLeftLinkPoint("[-32.5,0,18.5]");
        addLeftLinkPoint("[-32.5,5,18.5]");
        addLeftLinkPoint("[-29,8,18.5]");
        addLeftLinkPoint("[-13,10,18.5]");
        addLeftLinkPoint("[44,11,18.5]");
        addLeftLinkPoint("[49,11,18.5]");
        addRightLinkPoint("[51,11,-18]");
        addRightLinkPoint("[54.3,10,-18]");
        addRightLinkPoint("[54.3,3,-18]");
        addRightLinkPoint("[42,-9,-18]");
        addRightLinkPoint("[-18,-9,-18]");
        addRightLinkPoint("[-32.5,0,-18]");
        addRightLinkPoint("[-32.5,5,-18]");
        addRightLinkPoint("[-29,8,-18]");
        addRightLinkPoint("[-13,10,-18]");
        addRightLinkPoint("[44,11,-18]");
        addRightLinkPoint("[49,11,-18]");
