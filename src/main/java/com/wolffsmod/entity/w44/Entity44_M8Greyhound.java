...
public class Entity44_M8Greyhound extends EntityFlanVehicleNPC
{
    public Entity44_M8Greyhound(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setRotatedDriverOffset("-2 0 -6");
        setDriverAimSpeed("0.81 0.71 0");
        addBarrelPosition("50 30 0");
