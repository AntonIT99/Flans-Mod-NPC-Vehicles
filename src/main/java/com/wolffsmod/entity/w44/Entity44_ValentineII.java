...
public class Entity44_ValentineII extends EntityFlanVehicleNPC
{
    public Entity44_ValentineII(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.4F);
        setDriver("0 23 0 -360 360 -6 25");
        setRotatedDriverOffset("-5 0 0");
        setDriverAimSpeed("0.75 0.65 0");
        addBarrelPosition("47 24 0");
        ...
        addLeftLinkPoint("[41.5,10.5,23.5]");
        addLeftLinkPoint("[44.5,8,23.5]");
        addLeftLinkPoint("[44.5,1,23.5]");
        addLeftLinkPoint("[25,-9.5,23.5]");
        addLeftLinkPoint("[-50,-9.5,23.5]");
        addLeftLinkPoint("[-67.3,1,23.5]");
        addLeftLinkPoint("[-67.5,7,23.5]");
        addLeftLinkPoint("[-64,10.5,23.5]");
        addLeftLinkPoint("[20,10.5,23.5]");
        addLeftLinkPoint("[37,10.5,23.5]");
        addRightLinkPoint("[41.5,10.5,-23.5]");
        addRightLinkPoint("[44.5,8,-23.5]");
        addRightLinkPoint("[44.5,1,-23.5]");
        addRightLinkPoint("[25,-9.5,-23.5]");
        addRightLinkPoint("[-50,-9.5,-23.5]");
        addRightLinkPoint("[-67.3,1,-23.5]");
        addRightLinkPoint("[-67.5,7,-23.5]");
        addRightLinkPoint("[-64,10.5,-23.5]");
        addRightLinkPoint("[20,10.5,-23.5]");
        addRightLinkPoint("[37,10.5,-23.5]");
