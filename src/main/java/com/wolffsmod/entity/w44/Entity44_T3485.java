...
public class Entity44_T3485 extends EntityFlanVehicleNPC
{
    public Entity44_T3485(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
