...
public class Entity44_T70 extends EntityFlanVehicleNPC
{
    public Entity44_T70(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        addLeftLinkPoint("[39,11,-13.5]");
        addLeftLinkPoint("[43,9.5,-13.5]");
        addLeftLinkPoint("[43,4,-13.5]");
        addLeftLinkPoint("[37,-5,-13.5]");
        addLeftLinkPoint("[32,-10,-13.5]");
        addLeftLinkPoint("[-33,-10,-13.5]");
        addLeftLinkPoint("[-43,-1,-13.5]");
        addLeftLinkPoint("[-43,6,-13.5]");
        addLeftLinkPoint("[-38,8,-13.5]");
        addLeftLinkPoint("[23,11,-13.5]");
        addRightLinkPoint("[39,11,26.5]");
        addRightLinkPoint("[43,9.5,26.5]");
        addRightLinkPoint("[43,4,26.5]");
        addRightLinkPoint("[37,-5,26.5]");
        addRightLinkPoint("[32,-10,26.5]");
        addRightLinkPoint("[-33,-10,26.5]");
        addRightLinkPoint("[-43,-1,26.5]");
        addRightLinkPoint("[-43,6,26.5]");
        addRightLinkPoint("[-38,8,26.5]");
        addRightLinkPoint("[23,11,26.5]");
