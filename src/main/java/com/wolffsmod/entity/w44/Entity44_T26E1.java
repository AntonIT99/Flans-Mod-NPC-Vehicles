...
public class Entity44_T26E1 extends EntityFlanVehicleNPC
{
    public Entity44_T26E1(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setDriverAimSpeed("1.01 1.0 0");
        setPassenger("1 30 6 12 core -10 10 -10 10 44_30Cal PassengerGun1");
        addBarrelPosition("115 31 0");
