...
public class Entity44_SU76M extends EntityFlanVehicleNPC
{
    public Entity44_SU76M(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.35F);
        setDriver("-22 15 -5 -12 12 -10 20");
        setRotatedDriverOffset("0 0 0");
        setDriverAimSpeed("0.32 0.22 0");
        setPassenger("1 -15 18 10 core -30 30 -15 15 44_DT28 PassengerGun1");
        addBarrelPosition("48 24 -1");
        addGunOrigin("1 9 10 10");
        ...
        addLeftLinkPoint("[54,10,-19]");
        addLeftLinkPoint("[58,8,-19]");
        addLeftLinkPoint("[58,0,-19]");
        addLeftLinkPoint("[53,-5,-19]");
        addLeftLinkPoint("[48,-11,-19]");
        addLeftLinkPoint("[-31,-11,-19]");
        addLeftLinkPoint("[-41,-3,-19]");
        addLeftLinkPoint("[-41,4,-19]");
        addLeftLinkPoint("[-36,6.5,-19]");
        addLeftLinkPoint("[23,10,-19]");
        addRightLinkPoint("[54,10,27]");
        addRightLinkPoint("[58,8,27]");
        addRightLinkPoint("[58,0,27]");
        addRightLinkPoint("[53,-5,27]");
        addRightLinkPoint("[48,-11,27]");
        addRightLinkPoint("[-31,-11,27]");
        addRightLinkPoint("[-41,-3,27]");
        addRightLinkPoint("[-41,4,27]");
        addRightLinkPoint("[-36,6.5,27]");
        addRightLinkPoint("[23,10,27]");
