...
public class Entity44_M10Wolverine extends EntityFlanVehicleNPC
{
    public Entity44_M10Wolverine(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        addLeftLinkPoint("[45.5,8.5,18.1]");
        addLeftLinkPoint("[48.5,6.5,18.1]");
        addLeftLinkPoint("[48.5,2,18.1]");
        addLeftLinkPoint("[38,-7.5,18.1]");
        addLeftLinkPoint("[-34,-7.5,18.1]");
        addLeftLinkPoint("[-44.5,1,18.1]");
        addLeftLinkPoint("[-44.5,6,18.1]");
        addLeftLinkPoint("[-41,8.5,18.1]");
        addLeftLinkPoint("[-36,8.5,18.1]");
        addLeftLinkPoint("[30,8.5,18.1]");
        addLeftLinkPoint("[37,8.5,18.1]");
        addRightLinkPoint("[45.5,8.5,-18.1]");
        addRightLinkPoint("[48.5,6.5,-18.1]");
        addRightLinkPoint("[48.5,2,-18.1]");
        addRightLinkPoint("[38,-7.5,-18.1]");
        addRightLinkPoint("[-34,-7.5,-18.1]");
        addRightLinkPoint("[-44.5,1,-18.1]");
        addRightLinkPoint("[-44.5,6,-18.1]");
        addRightLinkPoint("[-41,8.5,-18.1]");
        addRightLinkPoint("[-36,8.5,-18.1]");
