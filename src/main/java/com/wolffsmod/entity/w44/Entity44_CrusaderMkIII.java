...
public class Entity44_CrusaderMkIII extends EntityFlanVehicleNPC
{
    public Entity44_CrusaderMkIII(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        addLeftLinkPoint("[61.5,9,24.5]");
        addLeftLinkPoint("[64.5,7,24.5]");
        addLeftLinkPoint("[64.5,2,24.5]");
        addLeftLinkPoint("[45,-9,24.5]");
        addLeftLinkPoint("[-40,-9,24.5]");
        addLeftLinkPoint("[-63.5,1,24.5]");
        addLeftLinkPoint("[-63.5,6,24.5]");
        addLeftLinkPoint("[-63,10,24.5]");
        addLeftLinkPoint("[-55,13,24.5]");
        addLeftLinkPoint("[51,11,24.5]");
        addLeftLinkPoint("[58,11,24.5]");
        addRightLinkPoint("[61.5,9,-24.5]");
        addRightLinkPoint("[64.5,7,-24.5]");
        addRightLinkPoint("[64.5,2,-24.5]");
        addRightLinkPoint("[45,-9,-24.5]");
        addRightLinkPoint("[-40,-9,-24.5]");
        addRightLinkPoint("[-63.5,1,-24.5]");
        addRightLinkPoint("[-63.5,6,-24.5]");
        addRightLinkPoint("[-63,10,-24.5]");
        addRightLinkPoint("[-55,13,-24.5]");
        addRightLinkPoint("[51,11,-24.5]");
        addRightLinkPoint("[58,11,-24.5]");
