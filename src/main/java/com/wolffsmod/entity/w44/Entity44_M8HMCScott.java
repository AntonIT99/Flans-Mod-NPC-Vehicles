...
public class Entity44_M8HMCScott extends EntityFlanVehicleNPC
{
    public Entity44_M8HMCScott(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
