...
public class Entity44_ZiS3 extends EntityFlanVehicleNPC
{
    public Entity44_ZiS3(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.0F);
        setDriver("0 -8 0 -16 16 -4 22");
        setRotatedDriverOffset("-19 0 -6");
        setDriverAimSpeed("0.4f 0.3f 0f");
        addBarrelPosition("62 6 0");
