...
public class Entity44_M18Hellcat extends EntityFlanVehicleNPC
{
    public Entity44_M18Hellcat(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.4818F);
        setDriver("0 28 0 -360 360 -8 15");
        setRotatedDriverOffset("-13 0 -9");
        setDriverAimSpeed("0.81 0.71 0");
        addBarrelPosition("68 29 0");
        ...
        addLeftLinkPoint("[35.5,9,18.5]");
        addLeftLinkPoint("[38.5,7,18.5]");
        addLeftLinkPoint("[38.5,2,18.5]");
        addLeftLinkPoint("[28,-7.5,18.5]");
        addLeftLinkPoint("[-28,-7.5,18.5]");
        addLeftLinkPoint("[-38.5,1,18.5]");
        addLeftLinkPoint("[-38.5,6,18.5]");
        addLeftLinkPoint("[-35,9,18.5]");
        addLeftLinkPoint("[-30,9,18.5]");
        addLeftLinkPoint("[25,9,18.5]");
        addLeftLinkPoint("[32,9,18.5]");
        addRightLinkPoint("[35.5,9,-18.5]");
        addRightLinkPoint("[38.5,7,-18.5]");
        addRightLinkPoint("[38.5,2,-18.5]");
        addRightLinkPoint("[28,-7.5,-18.5]");
        addRightLinkPoint("[-28,-7.5,-18.5]");
        addRightLinkPoint("[-38.5,1,-18.5]");
        addRightLinkPoint("[-38.5,6,-18.5]");
        addRightLinkPoint("[-35,9,-18.5]");
        addRightLinkPoint("[-30,9,-18.5]");
        addRightLinkPoint("[25,9,-18.5]");
        addRightLinkPoint("[32,9,-18.5]");
