...
public class Entity44_M157mm extends EntityFlanVehicleNPC
{
    public Entity44_M157mm(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.0F);
        setDriver("0 -3 0 -15 15 -10 10");
        setRotatedDriverOffset("-10 0 -8");
        setDriverAimSpeed("0.65f 0.55f 0f");
        addBarrelPosition("55 7 0");
