...
public class Entity44_Cromwell extends EntityFlanVehicleNPC
{
    public Entity44_Cromwell(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.505F);
        setDriver("0 30 0 -360 360 -13 20");
        setRotatedDriverOffset("-5 0 -10");
        setDriverAimSpeed("1.17 1.07 0");
        setPassenger("1 31 5 -13 core -10 10 -10 10 44_Bren PassengerGun1");
        addBarrelPosition("65 28 2");
        addGun("28 28 -4 turret 44_Bren");
        addGunOrigin("1 42 -4 -8");
        ...
        addLeftLinkPoint("[50.5,9,24.1]");
        addLeftLinkPoint("[53.5,7,24.1]");
        addLeftLinkPoint("[53.5,2,24.1]");
        addLeftLinkPoint("[43,-9,24.1]");
        addLeftLinkPoint("[-60,-9,24.1]");
        addLeftLinkPoint("[-70.5,1,24.1]");
        addLeftLinkPoint("[-70.5,6,24.1]");
        addLeftLinkPoint("[-67,9,24.1]");
        addLeftLinkPoint("[-62,9,24.1]");
        addLeftLinkPoint("[40,9,24.1]");
        addLeftLinkPoint("[47,9,24.1]");
        addRightLinkPoint("[50.5,9,-24.1]");
        addRightLinkPoint("[53.5,7,-24.1]");
        addRightLinkPoint("[53.5,2,-24.1]");
        addRightLinkPoint("[43,-9,-24.1]");
        addRightLinkPoint("[-60,-9,-24.1]");
        addRightLinkPoint("[-70.5,1,-24.1]");
        addRightLinkPoint("[-70.5,6,-24.1]");
        addRightLinkPoint("[-67,9,-24.1]");
        addRightLinkPoint("[-62,9,-24.1]");
        addRightLinkPoint("[40,9,-24.1]");
        addRightLinkPoint("[47,9,-24.1]");
