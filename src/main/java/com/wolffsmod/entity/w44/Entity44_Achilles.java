...
public class Entity44_Achilles extends EntityFlanVehicleNPC
{
    public Entity44_Achilles(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.415F);
        setDriver("0 22 0 -360 360 -8 15");
        setRotatedDriverOffset("-9 0 -8");
        setDriverAimSpeed("0.21 0.11 0");
        addBarrelPosition("75 30 0");
        addGun("2 45 0 turret 44_50Cal");
        ...
        addLeftLinkPoint("[44.5,8.5,18.1]");
        addLeftLinkPoint("[47.5,6.5,18.1]");
        addLeftLinkPoint("[47.5,2,18.1]");
        addLeftLinkPoint("[37,-7.5,18.1]");
        addLeftLinkPoint("[-34,-7.5,18.1]");
        addLeftLinkPoint("[-45.5,1,18.1]");
        addLeftLinkPoint("[-45.5,6,18.1]");
        addLeftLinkPoint("[-42,8.5,18.1]");
        addLeftLinkPoint("[-37,8.5,18.1]");
        addLeftLinkPoint("[30,8.5,18.1]");
        addLeftLinkPoint("[37,8.5,18.1]");
        addRightLinkPoint("[44.5,8.5,-18.1]");
        addRightLinkPoint("[47.5,6.5,-18.1]");
        addRightLinkPoint("[47.5,2,-18.1]");
        addRightLinkPoint("[37,-7.5,-18.1]");
        addRightLinkPoint("[-34,-7.5,-18.1]");
        addRightLinkPoint("[-45.5,1,-18.1]");
        addRightLinkPoint("[-45.5,6,-18.1]");
        addRightLinkPoint("[-42,8.5,-18.1]");
        addRightLinkPoint("[-37,8.5,-18.1]");
        addRightLinkPoint("[30,8.5,-18.1]");
        addRightLinkPoint("[37,8.5,-18.1]");
