...
public class Entity44_M24Chaffee extends EntityFlanVehicleNPC
{
    public Entity44_M24Chaffee(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setPassenger("1 21 5 12 core -10 10 -10 10 44_30Cal PassengerGun1");
        addBarrelPosition("50 26 0");
        addGun("20 28 6 turret 44_30Cal");
        addGun("-4 43 6 turret 44_50Cal");
        addGunOrigin("1 42 -12 15");
        ...
        addLeftLinkPoint("[40.5,9,24.1]");
        addLeftLinkPoint("[43.5,7,24.1]");
        addLeftLinkPoint("[43.5,2,24.1]");
        addLeftLinkPoint("[33,-8.5,24.1]");
        addLeftLinkPoint("[-38,-8.5,24.1]");
        addLeftLinkPoint("[-48.5,1,24.1]");
        addLeftLinkPoint("[-48.5,6,24.1]");
        addLeftLinkPoint("[-45,9,24.1]");
        addLeftLinkPoint("[-40,9,24.1]");
        addLeftLinkPoint("[30,9,24.1]");
        addLeftLinkPoint("[37,9,24.1]");
        addRightLinkPoint("[40.5,9,-24.1]");
        addRightLinkPoint("[43.5,7,-24.1]");
        addRightLinkPoint("[43.5,2,-24.1]");
        addRightLinkPoint("[33,-8.5,-24.1]");
        addRightLinkPoint("[-38,-8.5,-24.1]");
        addRightLinkPoint("[-48.5,1,-24.1]");
        addRightLinkPoint("[-48.5,6,-24.1]");
        addRightLinkPoint("[-45,9,-24.1]");
        addRightLinkPoint("[-40,9,-24.1]");
        addRightLinkPoint("[30,9,-24.1]");
        addRightLinkPoint("[37,9,-24.1]");
