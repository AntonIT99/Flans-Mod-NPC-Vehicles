...
public class Entity44_QF2Pdr extends EntityFlanVehicleNPC
{
    public Entity44_QF2Pdr(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.0F);
        setDriver("0 -3 0 -360 360 -5 15");
        setRotatedDriverOffset("-12 0 -9");
        setDriverAimSpeed("0.85f 0.75f 0f");
        addBarrelPosition("43 5 0");
