...
public class Entity44_Type2KaMi extends EntityFlanVehicleNPC
{
    public Entity44_Type2KaMi(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.395F);
        setDriver("0 47 0 -360 360 -10 24");
        setRotatedDriverOffset("-3 0 0");
        setDriverAimSpeed("0.6 0.5 0");
        addBarrelPosition("45 37 1");
        ...
        addLeftLinkPoint("[28,9,17]");
        addLeftLinkPoint("[31,6,17]");
        addLeftLinkPoint("[31,2,17]");
        addLeftLinkPoint("[28,-1,17]");
        addLeftLinkPoint("[28,-1,17]");
        addLeftLinkPoint("[16,-6,17]");
        addLeftLinkPoint("[-40,-6,17]");
        addLeftLinkPoint("[-40,-6,17]");
        addLeftLinkPoint("[-42,-3,17]");
        addLeftLinkPoint("[-42,1,17]");
        addLeftLinkPoint("[-42,1,17]");
        addLeftLinkPoint("[-39,4,17]");
        addLeftLinkPoint("[-9,9,17]");
        addLeftLinkPoint("[12,9,17]");
        addLeftLinkPoint("[24,9,17]");
        addRightLinkPoint("[28,9,-17]");
        addRightLinkPoint("[31,6,-17]");
        addRightLinkPoint("[31,2,-17]");
        addRightLinkPoint("[28,-1,-17]");
        addRightLinkPoint("[28,-1,-17]");
        addRightLinkPoint("[16,-6,-17]");
        addRightLinkPoint("[-40,-6,-17]");
        addRightLinkPoint("[-40,-6,-17]");
        addRightLinkPoint("[-42,-3,-17]");
        addRightLinkPoint("[-42,1,-17]");
        addRightLinkPoint("[-42,1,-17]");
        addRightLinkPoint("[-39,4,-17]");
        addRightLinkPoint("[-9,9,-17]");
        addRightLinkPoint("[12,9,-17]");
        addRightLinkPoint("[24,9,-17]");
