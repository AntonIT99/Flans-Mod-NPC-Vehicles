...
public class Entity44_PantherG extends EntityFlanVehicleNPC
{
    public Entity44_PantherG(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.45F);
        setDriver("0 34 0 -360 360 -8 18");
        setRotatedDriverOffset("-6 0 -8");
        setDriverAimSpeed("0.94 0.84 0");
        setPassenger("1 31 12 8 core -10 10 -10 10 44_Mg34 PassengerGun1");
        addBarrelPosition("100 34 0");
        addGun("25 34 8 turret 44_Mg34");
        addGun("11 50 -3 turret 44_Mg34");
