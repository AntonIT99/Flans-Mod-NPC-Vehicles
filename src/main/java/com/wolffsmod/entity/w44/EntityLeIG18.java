...
public class EntityLeIG18 extends EntityFlanVehicleNPC
{
    public EntityLeIG18(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.25F);
        setDriver("1 3 -7 -6 6 -10 73");
        setRotatedDriverOffset("0 0 0");
        setDriverAimSpeed("1.57f 1.80f 0f");
        addBarrelPosition("36 4 0");
