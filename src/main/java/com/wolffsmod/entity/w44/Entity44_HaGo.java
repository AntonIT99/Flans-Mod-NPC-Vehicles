...
public class Entity44_HaGo extends EntityFlanVehicleNPC
{
    public Entity44_HaGo(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.49F);
        setDriver("0 30 0 -360 360 -15 20");
        setRotatedDriverOffset("-2 0 0");
        setDriverAimSpeed("0.73 0.63 0");
        setPassenger("1 20 5 10 core -10 10 -10 10 44_Type99 PassengerGun1");
        addBarrelPosition("38 32 1");
        ...
        addLeftLinkPoint("[42.5,15,22]");
        addLeftLinkPoint("[45.5,12,22]");
        addLeftLinkPoint("[45.5,7,22]");
        addLeftLinkPoint("[30,-8.5,22]");
        addLeftLinkPoint("[-33,-8.5,22]");
        addLeftLinkPoint("[-51.3,-2,22]");
        addLeftLinkPoint("[-51.5,6,22]");
        addLeftLinkPoint("[-47,8,22]");
        addLeftLinkPoint("[-23,12,22]");
        addLeftLinkPoint("[20,14,22]");
        addLeftLinkPoint("[37,15,22]");
        addRightLinkPoint("[42.5,15,-17.5]");
        addRightLinkPoint("[45.5,12,-17.5]");
        addRightLinkPoint("[45.5,7,-17.5]");
        addRightLinkPoint("[30,-8.5,-17.5]");
        addRightLinkPoint("[-33,-8.5,-17.5]");
        addRightLinkPoint("[-51.5,-2,-17.5]");
        addRightLinkPoint("[-51.3,6,-17.5]");
        addRightLinkPoint("[-47,8,-17.5]");
        addRightLinkPoint("[-23,12,-17.5]");
        addRightLinkPoint("[20,14,-17.5]");
        addRightLinkPoint("[37,15,-17.5]");
