...
public class EntityLeFH18 extends EntityFlanVehicleNPC
{
    public EntityLeFH18(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.25F);
        setDriver("0 -5 -2 0 0 -10 65");
        setRotatedDriverOffset("14 0 -8");
        setDriverAimSpeed("1f 1f 0f");
        setPassenger("1 0 6 0 turret -360 360 -10 80");
        setPassengerAimSpeed("1 8.5 2.5 0");
        addBarrelPosition("65 10 0");
        addShootParticlesPrimary("flansmod.smoker 0 0 0");
        addShootParticlesPrimary("flansmod.rocketexhaust 0 0 0");
