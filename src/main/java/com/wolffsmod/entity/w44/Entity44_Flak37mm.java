...
public class Entity44_Flak37mm extends EntityFlanVehicleNPC
{
    public Entity44_Flak37mm(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.0F);
        setDriver("0 7 0 -360 360 -10 70");
        setRotatedDriverOffset("-32 0 12");
        setDriverAimSpeed("1.64f 1.54f 0f");
        addBarrelPosition("93 18 0");
