...
public class Entity44_Firefly extends EntityFlanVehicleNPC
{
    public Entity44_Firefly(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        addLeftLinkPoint("[44.5,9,18]");
        addLeftLinkPoint("[46.5,7,18]");
        addLeftLinkPoint("[46.5,2,18]");
        addLeftLinkPoint("[36,-7.5,18]");
        addLeftLinkPoint("[-36,-7.5,18]");
        addLeftLinkPoint("[-46.5,1,18]");
        addLeftLinkPoint("[-46.5,6,18]");
        addLeftLinkPoint("[-43,9,18]");
        addLeftLinkPoint("[-38,9,18]");
        addLeftLinkPoint("[34,9,18]");
        addLeftLinkPoint("[41,9,18]");
        addRightLinkPoint("[44.5,9,-17]");
        addRightLinkPoint("[47.5,7,-17]");
        addRightLinkPoint("[47.5,2,-17]");
        addRightLinkPoint("[37,-7.5,-17]");
        addRightLinkPoint("[-36,-7.5,-17]");
        addRightLinkPoint("[-46.5,1,-17]");
        addRightLinkPoint("[-46.5,6,-17]");
        addRightLinkPoint("[-43,9,-17]");
        addRightLinkPoint("[-38,9,-17]");
        addRightLinkPoint("[34,9,-17]");
        addRightLinkPoint("[41,9,-17]");
