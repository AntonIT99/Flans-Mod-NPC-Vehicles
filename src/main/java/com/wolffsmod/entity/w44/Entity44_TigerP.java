...
public class Entity44_TigerP extends EntityFlanVehicleNPC
{
    public Entity44_TigerP(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.275F);
        setDriver("0 38 0 -360 360 -6 17");
        setRotatedDriverOffset("-7 0 -15");
        setDriverAimSpeed("0.35 0.25 0");
        setPassenger("1 33 1 -10 core -10 10 -10 10 44_Mg34 PassengerGun1");
        addBarrelPosition("105 33 0");
        addGun("28 34 6 turret 44_Mg34");
        addGunOrigin("1 25 -4 10");
        ...
        addLeftLinkPoint("[35,9,21]");
        addLeftLinkPoint("[38,6,21]");
        addLeftLinkPoint("[38,1,21]");
        addLeftLinkPoint("[32,-6,21]");
        addLeftLinkPoint("[20,-7,21]");
        addLeftLinkPoint("[-60,-7,21]");
        addLeftLinkPoint("[-71,-2,21]");
        addLeftLinkPoint("[-71,4,21]");
        addLeftLinkPoint("[-68,8,21]");
        addLeftLinkPoint("[26,6.5,21]");
        addLeftLinkPoint("[30,9.5,21]");
        addRightLinkPoint("[35,9,-21]");
        addRightLinkPoint("[38.5,6,-21]");
        addRightLinkPoint("[38.5,1,-21]");
        addRightLinkPoint("[32,-6,-21]");
        addRightLinkPoint("[20,-7,-21]");
        addRightLinkPoint("[-60,-7,-21]");
        addRightLinkPoint("[-71,-2,-21]");
        addRightLinkPoint("[-71,4,-21]");
        addRightLinkPoint("[-68,8,-21]");
        addRightLinkPoint("[26,6.5,-21]");
        addRightLinkPoint("[30,9.5,-21]");
