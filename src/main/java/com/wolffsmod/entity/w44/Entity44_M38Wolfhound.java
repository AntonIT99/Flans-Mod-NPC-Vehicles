...
public class Entity44_M38Wolfhound extends EntityFlanVehicleNPC
{
    public Entity44_M38Wolfhound(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.68F);
        setDriver("0 24 0 -360 360 -8 15");
        setRotatedDriverOffset("-12 0 -7");
