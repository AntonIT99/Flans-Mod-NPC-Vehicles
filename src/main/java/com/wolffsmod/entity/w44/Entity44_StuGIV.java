...
public class Entity44_StuGIV extends EntityFlanVehicleNPC
{
    public Entity44_StuGIV(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.36F);
        setDriver("-8 24 -15 -5 5 -6 20");
        setRotatedDriverOffset("0 0 0");
        setDriverAimSpeed("0.7 0.6 0");
        setPassenger("1 -10 18 7 core -50 50 -18 20 44_Mg34 PassengerGun1");
        addBarrelPosition("76 20 0");
        addGunOrigin("1 5 14 5");
        ...
        addLeftLinkPoint("[49,12,20.2]");
        addLeftLinkPoint("[51.3,10,20.2]");
        addLeftLinkPoint("[51.3,3,20.2]");
        addLeftLinkPoint("[40,-9,20.2]");
        addLeftLinkPoint("[-29,-9,20.2]");
        addLeftLinkPoint("[-46.5,1,20.2]");
        addLeftLinkPoint("[-46.5,6,20.2]");
        addLeftLinkPoint("[-42,10,20.2]");
        addLeftLinkPoint("[-39,11,20.2]");
        addLeftLinkPoint("[31,13,20.2]");
        addLeftLinkPoint("[46,12,20.2]");
        addRightLinkPoint("[49,12,-25.2]");
        addRightLinkPoint("[51.3,10,-25.2]");
        addRightLinkPoint("[51.3,3,-25.2]");
        addRightLinkPoint("[46,-5,-25.2]");
        addRightLinkPoint("[40,-9,-25.2]");
        addRightLinkPoint("[-29,-9,-25.2]");
        addRightLinkPoint("[-46.5,1,-25.2]");
        addRightLinkPoint("[-46.5,6,-25.2]");
        addRightLinkPoint("[-42,10,-25.2]");
        addRightLinkPoint("[-39,11,-25.2]");
        addRightLinkPoint("[31,13,-25.2]");
        addRightLinkPoint("[46,12,-25.2]");
