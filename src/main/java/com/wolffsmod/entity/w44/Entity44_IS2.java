...
public class Entity44_IS2 extends EntityFlanVehicleNPC
{
    public Entity44_IS2(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    {
        setTurnSpeed(0.385F);
        setDriver("0 40 0 -360 360 -3 20");
        setRotatedDriverOffset("-15 0 -12");
        setDriverAimSpeed("0.47 0.37 0");
        addBarrelPosition("124 35 2");
        ...
        addLeftLinkPoint("[46,13.5,24.5]");
        addLeftLinkPoint("[51.5,8,24.5]");
        addLeftLinkPoint("[51.5,2,24.5]");
        addLeftLinkPoint("[46.5,-2,24.5]");
        addLeftLinkPoint("[33.5,-8,24.5]");
        addLeftLinkPoint("[-62,-8,24.5]");
        addLeftLinkPoint("[-76,-4,24.5]");
        addLeftLinkPoint("[-82,-1.5,24.5]");
        addLeftLinkPoint("[-82,10,24.5]");
        addLeftLinkPoint("[-76.5,13.5,24.5]");
        addLeftLinkPoint("[-54.5,13,24.5]");
        addLeftLinkPoint("[23,13,24.5]");
        addLeftLinkPoint("[42,13,24.5]");
        addRightLinkPoint("[46,13.5,-24.5]");
        addRightLinkPoint("[51.5,8,-24.5]");
        addRightLinkPoint("[51.5,2,-24.5]");
        addRightLinkPoint("[46.5,-2,-24.5]");
        addRightLinkPoint("[33.5,-8,-24.5]");
        addRightLinkPoint("[-62,-8,-24.5]");
        addRightLinkPoint("[-76,-4,-24.5]");
        addRightLinkPoint("[-82,-1.5,-24.5]");
        addRightLinkPoint("[-82,10,-24.5]");
        addRightLinkPoint("[-76.5,13.5,-24.5]");
        addRightLinkPoint("[-54.5,13,-24.5]");
        addRightLinkPoint("[23,13,-24.5]");
        addRightLinkPoint("[42,13,-24.5]");
