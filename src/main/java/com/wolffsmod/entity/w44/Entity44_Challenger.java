...
public class Entity44_Challenger extends EntityFlanVehicleNPC
{
    public Entity44_Challenger(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setRotatedDriverOffset("2 0 12");
        setDriverAimSpeed("0.65 0.55 0");
        addBarrelPosition("86 32 0");
        addGun("20 34 6 turret 44_Bren");
        ...
        addLeftLinkPoint("[56.5,9,24.1]");
        addLeftLinkPoint("[59.5,7,24.1]");
        addLeftLinkPoint("[59.5,2,24.1]");
        addLeftLinkPoint("[43,-9,24.1]");
        addLeftLinkPoint("[-63,-9,24.1]");
        addLeftLinkPoint("[-73.5,1,24.1]");
        addLeftLinkPoint("[-73.5,6,24.1]");
        addLeftLinkPoint("[-70,9,24.1]");
        addLeftLinkPoint("[-65,9,24.1]");
        addLeftLinkPoint("[40,9,24.1]");
        addLeftLinkPoint("[47,9,24.1]");
        addRightLinkPoint("[56.5,9,-24.1]");
        addRightLinkPoint("[59.5,7,-24.1]");
        addRightLinkPoint("[59.5,2,-24.1]");
        addRightLinkPoint("[43,-9,-24.1]");
        addRightLinkPoint("[-63,-9,-24.1]");
        addRightLinkPoint("[-73.5,1,-24.1]");
        addRightLinkPoint("[-73.5,6,-24.1]");
        addRightLinkPoint("[-70,9,-24.1]");
        addRightLinkPoint("[-65,9,-24.1]");
