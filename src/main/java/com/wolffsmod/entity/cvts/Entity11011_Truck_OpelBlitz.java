...
public class Entity11011_Truck_OpelBlitz extends EntityFlanVehicleNPC
{
    public Entity11011_Truck_OpelBlitz(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setPassenger("1 8 -8 8 core -360 360 -89 89");
        setPassenger("2 -12 -2 -10 core 60 160 -45 45 dummygun DummyGun");
