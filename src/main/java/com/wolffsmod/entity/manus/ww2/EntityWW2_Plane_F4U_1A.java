...
public class EntityWW2_Plane_F4U_1A extends EntityFlanPlaneNPC
{
    public EntityWW2_Plane_F4U_1A(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        addShootPointSecondary("32 13 -54 leftWing");
        addShootPointSecondary("32 13 54 rightWing");
