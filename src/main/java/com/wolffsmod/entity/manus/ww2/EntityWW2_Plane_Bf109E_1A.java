...
public class EntityWW2_Plane_Bf109E_1A extends EntityFlanPlaneNPC
{
    public EntityWW2_Plane_Bf109E_1A(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        setTurnSpeed(2.0F);
        setDriver("-21 18 0");
        addShootPointPrimary("47 31 3 core WW2_MG_MGFF_1A");
        addShootPointPrimary("47 31 -3 core WW2_MG_MGFF_1A");
