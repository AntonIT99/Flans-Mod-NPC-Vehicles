...
public class EntityT3TToyotaHiluxDSHK extends EntityFlanVehicleNPC
{
    public EntityT3TToyotaHiluxDSHK(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setPassenger("2 -17 18 0 core -360 360 -15 65 dshkGun PassengerGun1");
