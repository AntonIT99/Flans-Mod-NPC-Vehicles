...
public class EntityEurocopterTigerUHT extends EntityFlanPlaneNPC
{
    public EntityEurocopterTigerUHT(World w)
    {
        super(w);
        setSize(3.5F, 2.5F);
    }
    ...
    public void setupConfig()
    {
        ...
        setPassenger("2 100 -7 0 core -90 90 -55 13 twelveMM PassengerGun1");
        setPassengerAimSpeed("2 8 8 0");
        addShootPointPrimary("20 17 38 rightWing HydraPod");
