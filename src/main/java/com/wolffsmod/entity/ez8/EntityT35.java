...
public class EntityT35 extends EntityFlanVehicleNPC
{
    ...
    public void setupConfig()
    {
        ...
        setPassenger("1 26 17 8 nose -30 135 -5 15 vg_45mm_m1934 Nose");
        setPassenger("2 -26 17 -8 nose 145 310 -5 15 vg_45mm_m1934 Nose2");
        setPassenger("3 22 14 -11 nose -135 20 -10 10 vg_7.62mm_lmg Nose3");
        setPassenger("4 -22 14 11 nose 45 200 -10 10 vg_7.62mm_lmg Nose4");
        setPassengerOffsetYaw(1, 0F);
        setPassengerOffsetYaw(2, 180F);
        setPassengerOffsetYaw(3, 0F);
        setPassengerOffsetYaw(4, 180F);
