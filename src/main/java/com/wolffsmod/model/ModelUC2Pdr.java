...
public class ModelUC2Pdr extends ModelVehicle //Same as Filename
{
    ...
    public ModelUC2Pdr() //Same as Filename
    {
        ...
        bodyDoorOpenModel = new ModelRendererTurbo[35];
        bodyDoorOpenModel[0] = new ModelRendererTurbo(this, 1, 181, textureX, textureY); // Box 0
        bodyDoorOpenModel[1] = new ModelRendererTurbo(this, 25, 181, textureX, textureY); // Box 1
        bodyDoorOpenModel[2] = new ModelRendererTurbo(this, 41, 181, textureX, textureY); // Box 2
        bodyDoorOpenModel[3] = new ModelRendererTurbo(this, 1, 189, textureX, textureY); // Box 3
        bodyDoorOpenModel[4] = new ModelRendererTurbo(this, 25, 189, textureX, textureY); // Box 4
        bodyDoorOpenModel[5] = new ModelRendererTurbo(this, 49, 181, textureX, textureY); // Box 5
        bodyDoorOpenModel[6] = new ModelRendererTurbo(this, 57, 181, textureX, textureY); // Box 6
        bodyDoorOpenModel[7] = new ModelRendererTurbo(this, 49, 189, textureX, textureY); // Box 7
        bodyDoorOpenModel[8] = new ModelRendererTurbo(this, 1, 197, textureX, textureY); // Box 8
        bodyDoorOpenModel[9] = new ModelRendererTurbo(this, 17, 197, textureX, textureY); // Box 9
        bodyDoorOpenModel[10] = new ModelRendererTurbo(this, 33, 197, textureX, textureY); // Box 10
        bodyDoorOpenModel[11] = new ModelRendererTurbo(this, 49, 197, textureX, textureY); // Box 11
        bodyDoorOpenModel[12] = new ModelRendererTurbo(this, 57, 197, textureX, textureY); // Box 12
        bodyDoorOpenModel[13] = new ModelRendererTurbo(this, 1, 205, textureX, textureY); // Box 13
        bodyDoorOpenModel[14] = new ModelRendererTurbo(this, 9, 205, textureX, textureY); // Box 14
        bodyDoorOpenModel[15] = new ModelRendererTurbo(this, 17, 205, textureX, textureY); // Box 15
        bodyDoorOpenModel[16] = new ModelRendererTurbo(this, 25, 205, textureX, textureY); // Box 16
        bodyDoorOpenModel[17] = new ModelRendererTurbo(this, 33, 205, textureX, textureY); // Box 17
        bodyDoorOpenModel[18] = new ModelRendererTurbo(this, 41, 205, textureX, textureY); // Box 18
        bodyDoorOpenModel[19] = new ModelRendererTurbo(this, 49, 205, textureX, textureY); // Box 19
        bodyDoorOpenModel[20] = new ModelRendererTurbo(this, 57, 205, textureX, textureY); // Box 20
        bodyDoorOpenModel[21] = new ModelRendererTurbo(this, 1, 213, textureX, textureY); // Box 21
        bodyDoorOpenModel[22] = new ModelRendererTurbo(this, 9, 213, textureX, textureY); // Box 22
        bodyDoorOpenModel[23] = new ModelRendererTurbo(this, 17, 213, textureX, textureY); // Box 23
        bodyDoorOpenModel[24] = new ModelRendererTurbo(this, 25, 213, textureX, textureY); // Box 24
        bodyDoorOpenModel[25] = new ModelRendererTurbo(this, 33, 213, textureX, textureY); // Box 25
        bodyDoorOpenModel[26] = new ModelRendererTurbo(this, 41, 213, textureX, textureY); // Box 26
        bodyDoorOpenModel[27] = new ModelRendererTurbo(this, 49, 213, textureX, textureY); // Box 27
        bodyDoorOpenModel[28] = new ModelRendererTurbo(this, 1, 221, textureX, textureY); // Box 28
        bodyDoorOpenModel[29] = new ModelRendererTurbo(this, 17, 221, textureX, textureY); // Box 29
        bodyDoorOpenModel[30] = new ModelRendererTurbo(this, 33, 221, textureX, textureY); // Box 30
        bodyDoorOpenModel[31] = new ModelRendererTurbo(this, 57, 213, textureX, textureY); // Box 31
        bodyDoorOpenModel[32] = new ModelRendererTurbo(this, 49, 221, textureX, textureY); // Box 32
        bodyDoorOpenModel[33] = new ModelRendererTurbo(this, 57, 221, textureX, textureY); // Box 33
        bodyDoorOpenModel[34] = new ModelRendererTurbo(this, 34, 202, textureX, textureY); // Box 0

        bodyDoorOpenModel[0].addShapeBox(-1F, -2F, -1F, 10, 1, 1, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F); // Box 0

        bodyDoorOpenModel[1].addShapeBox(9F, -2F, -1F, 4, 1, 1, 0F, 0F, -0.2F, -0.2F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.2F, -0.2F); // Box 1

        bodyDoorOpenModel[2].addShapeBox(2F, -2F, -1F, 1, 1, 1, 0F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F); // Box 2

        bodyDoorOpenModel[3].addShapeBox(-8F, -2F, -1F, 7, 2, 1, 0F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, -0.2F, 0.2F, 0F, -0.2F, 0.2F, 0F, 0F, 0.2F); // Box 3

        bodyDoorOpenModel[4].addShapeBox(-1.8F, -1.2F, -1F, 9, 1, 1, 0F, 0.01F, -0.3F, -0.3F, 0.01F, -0.3F, -0.3F, 0.01F, -0.3F, -0.3F, 0.01F, -0.3F, -0.3F, 0.01F, 0F, -0.3F, 0.01F, 0F, -0.3F, 0.01F, 0F, -0.3F, 0.01F, 0F, -0.3F); // Box 4

        bodyDoorOpenModel[5].addShapeBox(6F, -2F, -1F, 1, 1, 1, 0F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F, 0.2F, -0.1F, -0.1F); // Box 5

        bodyDoorOpenModel[6].addShapeBox(6F, -1.2F, -1F, 1, 1, 1, 0F, 0.1F, -0.1F, -0.4F, 0.1F, -0.1F, -0.4F, 0.1F, -0.1F, -0.4F, 0.1F, -0.1F, -0.4F, 0.1F, -0.3F, -0.4F, 0.1F, -0.3F, -0.4F, 0.1F, -0.3F, -0.4F, 0.1F, -0.3F, -0.4F); // Box 6

        bodyDoorOpenModel[7].addShapeBox(-7F, -2F, -1F, 5, 1, 1, 0F, 0F, 0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 7

        bodyDoorOpenModel[8].addShapeBox(-6F, -3.1F, -1F, 3, 1, 1, 0F, -0.1F, 0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.1F, 0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0.2F, -0.2F, 0F, 0.2F, -0.2F, 0F, 0F, -0.2F); // Box 8

        bodyDoorOpenModel[9].addShapeBox(-5.9F, -4.6F, -1F, 3, 1, 1, 0F, -0.3F, 0.5F, -0.2F, 0.1F, -0.2F, -0.2F, 0.1F, -0.2F, -0.2F, -0.3F, 0.5F, -0.2F, 0F, 0F, -0.2F, -0.1F, 0.5F, -0.2F, -0.1F, 0.5F, -0.2F, 0F, 0F, -0.2F); // Box 9

        bodyDoorOpenModel[10].addShapeBox(-5.6F, -6.1F, -1F, 3, 1, 1, 0F, -0.8F, 0.5F, -0.2F, 0.4F, -0.5F, -0.2F, 0.4F, -0.5F, -0.2F, -0.8F, 0.5F, -0.2F, 0F, 0F, -0.2F, -0.2F, 0.7F, -0.2F, -0.2F, 0.7F, -0.2F, 0F, 0F, -0.2F); // Box 10

        bodyDoorOpenModel[11].addShapeBox(-10F, -2F, -1F, 2, 2, 1, 0F, 0F, -0.2F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 11

        bodyDoorOpenModel[12].addShapeBox(-11F, -2F, -1F, 1, 2, 1, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 12

        bodyDoorOpenModel[13].addShapeBox(-13F, -1F, -1F, 2, 1, 1, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.3F, 0F); // Box 13

        bodyDoorOpenModel[14].addShapeBox(-14F, -1F, -1F, 1, 1, 1, 0F, 0F, 0.5F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.5F, 0F); // Box 14

        bodyDoorOpenModel[15].addShapeBox(-15F, -1F, -1F, 1, 1, 1, 0F, 0F, 0.3F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.3F, 0F, 0F, 0.8F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.8F, 0F); // Box 15

        bodyDoorOpenModel[16].addShapeBox(-8F, 0F, -1F, 1, 3, 1, 0F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0.2F, -0.3F, -0.1F, -0.2F, -0.3F, -0.1F, -0.2F, -0.3F, -0.1F, 0.2F, -0.3F, -0.1F); // Box 16

        bodyDoorOpenModel[17].addShapeBox(-7.5F, -0.2F, -1F, 2, 1, 1, 0F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F); // Box 17

        bodyDoorOpenModel[18].addShapeBox(9F, -2F, -1F, 1, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 18

        bodyDoorOpenModel[19].addShapeBox(9F, -3F, 0F, 1, 1, 1, 0F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F); // Box 19

        bodyDoorOpenModel[20].addShapeBox(9F, -3F, 0.4F, 1, 1, 1, 0F, 0F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F); // Box 20

        bodyDoorOpenModel[21].addShapeBox(9F, -3F, -0.4F, 1, 1, 1, 0F, 0F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, -0.2F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F); // Box 21

        bodyDoorOpenModel[22].addShapeBox(9F, -3F, 0F, 1, 1, 1, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 22

        bodyDoorOpenModel[23].addShapeBox(-4F, -3F, -0.5F, 1, 1, 1, 0F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F); // Box 23

        bodyDoorOpenModel[24].addShapeBox(-4F, -3F, 0.5F, 1, 1, 1, 0F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F); // Box 24

        bodyDoorOpenModel[25].addShapeBox(-4F, -3F, -0.5F, 1, 1, 2, 0F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, -0.8F, -0.4F, 0F, -0.8F, -0.4F, 0F, -0.8F, -0.4F, 0F, -0.8F, -0.4F); // Box 25

        bodyDoorOpenModel[26].addShapeBox(-4F, -2.2F, -0.5F, 1, 1, 2, 0F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, -0.8F, -0.4F, 0F, -0.8F, -0.4F, 0F, -0.8F, -0.4F, 0F, -0.8F, -0.4F); // Box 26

        bodyDoorOpenModel[27].addShapeBox(2F, -2F, -0.2F, 1, 1, 2, 0F, 0.2F, -0.4F, -0.1F, 0.2F, -0.4F, -0.1F, 0.2F, 0.6F, -0.1F, 0.2F, 0.6F, -0.1F, 0.2F, -0.4F, -0.1F, 0.2F, -0.4F, -0.1F, 0.2F, -1.4F, -0.1F, 0.2F, -1.4F, -0.1F); // Box 27

        bodyDoorOpenModel[28].addShapeBox(1F, -3F, 1.6F, 3, 1, 1, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F); // Box 28

        bodyDoorOpenModel[29].addShapeBox(5.2F, -0.5F, -1F, 6, 1, 1, 0F, 0F, -0.3F, -0.3F, 0F, -1.3F, -2.3F, 0F, -1.3F, 1.7F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, 0.7F, -2.3F, 0F, 0.7F, 1.7F, 0F, -0.3F, -0.3F); // Box 29

        bodyDoorOpenModel[30].addShapeBox(5.2F, -0.5F, -1F, 6, 1, 1, 0F, 0F, -0.3F, -0.3F, 0F, -1.3F, 1.7F, 0F, -1.3F, -2.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, 0.7F, 1.7F, 0F, 0.7F, -2.3F, 0F, -0.3F, -0.3F); // Box 30

        bodyDoorOpenModel[31].addShapeBox(5F, -0.5F, -1F, 1, 1, 1, 0F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F); // Box 31

        bodyDoorOpenModel[32].addShapeBox(11F, 0.5F, 1F, 1, 1, 1, 0F, -0.2F, -0.2F, -0.2F, -0.6F, -0.2F, -0.2F, -0.6F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, 0F, -0.2F, -0.6F, 0F, -0.2F, -0.6F, 0F, -0.2F, -0.2F, 0F, -0.2F); // Box 32

        bodyDoorOpenModel[33].addShapeBox(11F, 0.5F, -3F, 1, 1, 1, 0F, -0.2F, -0.2F, -0.2F, -0.6F, -0.2F, -0.2F, -0.6F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, -0.2F, 0F, -0.2F, -0.6F, 0F, -0.2F, -0.6F, 0F, -0.2F, -0.2F, 0F, -0.2F); // Box 33

        bodyDoorOpenModel[34].addShapeBox(-7F, -0.5F, -1F, 1, 1, 1, 0F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F); // Box 0

        //Gun Origin
        for(ModelRendererTurbo gunPart : bodyDoorOpenModel)
        {
        ...
        trailerModel = new ModelRendererTurbo[29];
        trailerModel[0] = new ModelRendererTurbo(this, 1, 231, textureX, textureY); // Box 0
        trailerModel[1] = new ModelRendererTurbo(this, 33, 231, textureX, textureY); // Box 1
        trailerModel[2] = new ModelRendererTurbo(this, 65, 231, textureX, textureY); // Box 4
        trailerModel[3] = new ModelRendererTurbo(this, 1, 239, textureX, textureY); // Box 5
        trailerModel[4] = new ModelRendererTurbo(this, 97, 239, textureX, textureY); // Box 15
        trailerModel[5] = new ModelRendererTurbo(this, 1, 247, textureX, textureY); // Box 16
        trailerModel[6] = new ModelRendererTurbo(this, 33, 247, textureX, textureY); // Box 18
        trailerModel[7] = new ModelRendererTurbo(this, 49, 247, textureX, textureY); // Box 54
        trailerModel[8] = new ModelRendererTurbo(this, 57, 247, textureX, textureY); // Box 55
        trailerModel[9] = new ModelRendererTurbo(this, 65, 247, textureX, textureY); // Box 56
        trailerModel[10] = new ModelRendererTurbo(this, 73, 247, textureX, textureY); // Box 67
        trailerModel[11] = new ModelRendererTurbo(this, 81, 247, textureX, textureY); // Box 68
        trailerModel[12] = new ModelRendererTurbo(this, 89, 247, textureX, textureY); // Box 69
        trailerModel[13] = new ModelRendererTurbo(this, 97, 247, textureX, textureY); // Box 70
        trailerModel[14] = new ModelRendererTurbo(this, 105, 247, textureX, textureY); // Box 71
        trailerModel[15] = new ModelRendererTurbo(this, 113, 247, textureX, textureY); // Box 72
        trailerModel[16] = new ModelRendererTurbo(this, 1, 239, textureX, textureY); // Box 73
        trailerModel[17] = new ModelRendererTurbo(this, 41, 247, textureX, textureY); // Box 74
        trailerModel[18] = new ModelRendererTurbo(this, 1, 255, textureX, textureY); // Box 75
        trailerModel[19] = new ModelRendererTurbo(this, 17, 255, textureX, textureY); // Box 77
        trailerModel[20] = new ModelRendererTurbo(this, 25, 255, textureX, textureY); // Box 78
        trailerModel[21] = new ModelRendererTurbo(this, 17, 271, textureX, textureY); // Box 100
        trailerModel[22] = new ModelRendererTurbo(this, 33, 271, textureX, textureY); // Box 101
        trailerModel[23] = new ModelRendererTurbo(this, 49, 271, textureX, textureY); // Box 102
        trailerModel[24] = new ModelRendererTurbo(this, 65, 271, textureX, textureY); // Box 103
        trailerModel[25] = new ModelRendererTurbo(this, 81, 271, textureX, textureY); // Box 1
        trailerModel[26] = new ModelRendererTurbo(this, 97, 271, textureX, textureY); // Box 2
        trailerModel[27] = new ModelRendererTurbo(this, 113, 271, textureX, textureY); // Box 3
        trailerModel[28] = new ModelRendererTurbo(this, 1, 279, textureX, textureY); // Box 4

        trailerModel[0].addShapeBox(-6F, 5F, -5.5F, 12, 1, 3, 0F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0

        trailerModel[1].addBox(-6F, 5F, -2.5F, 12, 1, 5, 0F); // Box 1

        trailerModel[2].addShapeBox(-6F, 4F, -5.5F, 12, 1, 3, 0F, -3F, 0F, -1F, -3F, 0F, -1F, -1F, 0F, 0F, -1F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 4

        trailerModel[3].addShapeBox(-6F, 4F, -2.5F, 12, 1, 5, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 5

        trailerModel[4].addShapeBox(-6F, 5F, 2.5F, 12, 1, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F); // Box 15

        trailerModel[5].addShapeBox(-6F, 4F, 2.5F, 12, 1, 3, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -3F, 0F, -1F, -3F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, -3F, 0F, 0F, -3F, 0F, 0F); // Box 16

        trailerModel[6].addShapeBox(6.2F, -6.5F, 7.7F, 1, 12, 3, 0F, 3.4F, -0.7F, 0F, -4F, -0.7F, 0F, -6.3F, -0.7F, 2F, 5.7F, -0.7F, 2F, -0.6F, -0.3F, 6.2F, 0F, -0.3F, 6.2F, -6.3F, -0.3F, 2F, 5.7F, -0.3F, 2F); // Box 18

        trailerModel[7].addShapeBox(2.2F, -6.8F, 2.3F, 1, 1, 2, 0F, -0.3F, -0.3F, -0.6F, -0.3F, -0.3F, -0.6F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.6F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0F, 0F, -0.6F, 0F, 0F); // Box 54

        trailerModel[8].addShapeBox(2.2F, -6.8F, 4.3F, 1, 1, 2, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, 0F, 0F); // Box 55

        trailerModel[9].addShapeBox(2.2F, -6.8F, 6.3F, 1, 1, 2, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, -0.3F, -0.6F, -0.3F, -0.3F, -0.6F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, -0.6F, 0F, -0.6F); // Box 56

        trailerModel[10].addShapeBox(2.2F, -6.8F, 1F, 1, 1, 2, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, -0.3F, -0.6F, -0.3F, -0.3F, -0.6F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, -0.6F, 0F, -0.6F); // Box 67

        trailerModel[11].addShapeBox(2.2F, -6.8F, -1F, 1, 1, 2, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, 0F, 0F); // Box 68

        trailerModel[12].addShapeBox(2.2F, -6.8F, -3F, 1, 1, 2, 0F, -0.3F, -0.3F, -0.6F, -0.3F, -0.3F, -0.6F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.6F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0F, 0F, -0.6F, 0F, 0F); // Box 69

        trailerModel[13].addShapeBox(2.2F, -6.8F, -8.3F, 1, 1, 2, 0F, -0.3F, -0.3F, -0.6F, -0.3F, -0.3F, -0.6F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.6F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0F, 0F, -0.6F, 0F, 0F); // Box 70

        trailerModel[14].addShapeBox(2.2F, -6.8F, -6.3F, 1, 1, 2, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, 0F, 0F); // Box 71

        trailerModel[15].addShapeBox(2.2F, -6.8F, -4.3F, 1, 1, 2, 0F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, -0.3F, -0.6F, -0.3F, -0.3F, -0.6F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, -0.6F, 0F, -0.6F); // Box 72

        trailerModel[16].addShapeBox(2.2F, -6.8F, -3.15F, 1, 1, 1, 0F, -0.3F, -0.3F, -0.25F, -0.3F, -0.3F, -0.25F, -0.3F, -0.3F, -0.25F, -0.3F, -0.3F, -0.25F, -0.6F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, -0.6F, 0F, -0.25F); // Box 73

        trailerModel[17].addShapeBox(2.2F, -6.8F, 2.15F, 1, 1, 1, 0F, -0.3F, -0.3F, -0.25F, -0.3F, -0.3F, -0.25F, -0.3F, -0.3F, -0.25F, -0.3F, -0.3F, -0.25F, -0.6F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, -0.6F, 0F, -0.25F); // Box 74

        trailerModel[18].addShapeBox(6.5F, -5.8F, 1.5F, 1, 11, 6, 0F, 3.7F, 0F, 0.2F, -4.3F, 0F, 0.2F, -4.3F, 0F, 0.2F, 3.7F, 0F, 0.2F, -0.3F, 0F, 0.2F, -0.3F, 0F, 0.2F, -0.3F, 0F, -6F, -0.3F, 0F, -6F); // Box 75

        trailerModel[19].addShapeBox(6.5F, -5.8F, -1F, 1, 3, 2, 0F, 3.7F, 0F, 0.3F, -4.3F, 0F, 0.3F, -4.3F, 0F, 0.3F, 3.7F, 0F, 0.3F, 2.6F, 0F, 0.3F, -3.2F, 0F, 0.3F, -3.2F, 0F, 0.3F, 2.6F, 0F, 0.3F); // Box 77

        trailerModel[20].addShapeBox(9.5F, 3.2F, -1F, 1, 2, 2, 0F, 3.45F, 0F, 0.3F, -4F, 0F, 0.3F, -4F, 0F, 0.3F, 3.45F, 0F, 0.3F, 2.7F, 0F, 0.3F, -3.3F, 0F, 0.3F, -3.3F, 0F, 0.3F, 2.7F, 0F, 0.3F); // Box 78

        trailerModel[21].addShapeBox(-3F, -1F, -3.6F, 6, 2, 1, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 100

        trailerModel[22].addShapeBox(-3F, -1F, 2.6F, 6, 2, 1, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 101

        trailerModel[23].addShapeBox(-3F, 1F, 2.6F, 6, 3, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 102

        trailerModel[24].addShapeBox(-3F, 1F, -3.6F, 6, 3, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 103

        trailerModel[25].addShapeBox(6.2F, -6.5F, -10.7F, 1, 12, 3, 0F, 5.7F, -0.78F, 2F, -6.3F, -0.7F, 2F, -4F, -0.7F, 0F, 3.4F, -0.7F, 0F, 5.7F, -0.3F, 2F, -6.3F, -0.3F, 2F, 0F, -0.3F, 6.2F, -0.6F, -0.3F, 6.2F); // Box 1

        trailerModel[26].addShapeBox(6.5F, -5.8F, -7.5F, 1, 11, 6, 0F, 3.7F, 0F, 0.2F, -4.3F, 0F, 0.2F, -4.3F, 0F, 0.2F, 3.7F, 0F, 0.2F, -0.3F, 0F, -6F, -0.3F, 0F, -6F, -0.3F, 0F, 0.2F, -0.3F, 0F, 0.2F); // Box 2

        trailerModel[27].addShapeBox(6.2F, -7.3F, 7.7F, 1, 2, 3, 0F, 3.7F, -0.8F, 0F, -4.3F, -0.8F, 0F, -6.3F, -0.8F, 2F, 5.7F, -0.8F, 2F, 3.4F, -0.5F, 0F, -4F, -0.5F, 0F, -6.3F, -0.5F, 2F, 5.7F, -0.5F, 2F); // Box 3

        trailerModel[28].addShapeBox(6.2F, -7.3F, -10.7F, 1, 2, 3, 0F, 5.7F, -0.8F, 2F, -6.3F, -0.8F, 2F, -4.3F, -0.8F, 0F, 3.7F, -0.8F, 0F, 5.7F, -0.5F, 2F, -6.3F, -0.5F, 2F, -4F, -0.5F, 0F, 3.4F, -0.5F, 0F); // Box 4

        //Gun Origin
        for(ModelRendererTurbo gunPart : trailerModel)
        {
        ...
        bodyDoorCloseModel[0] = new ModelRendererTurbo(this, 97, 231, textureX, textureY); // Box 9
        bodyDoorCloseModel[1] = new ModelRendererTurbo(this, 113, 231, textureX, textureY); // Box 10
        bodyDoorCloseModel[2] = new ModelRendererTurbo(this, 33, 239, textureX, textureY); // Box 11
        bodyDoorCloseModel[3] = new ModelRendererTurbo(this, 33, 231, textureX, textureY); // Box 12
        bodyDoorCloseModel[4] = new ModelRendererTurbo(this, 49, 239, textureX, textureY); // Box 13
        bodyDoorCloseModel[5] = new ModelRendererTurbo(this, 65, 239, textureX, textureY); // Box 14
        bodyDoorCloseModel[6] = new ModelRendererTurbo(this, 121, 247, textureX, textureY); // Box 76
        bodyDoorCloseModel[7] = new ModelRendererTurbo(this, 49, 255, textureX, textureY); // Box 81
        bodyDoorCloseModel[8] = new ModelRendererTurbo(this, 65, 255, textureX, textureY); // Box 82
        bodyDoorCloseModel[9] = new ModelRendererTurbo(this, 81, 255, textureX, textureY); // Box 90
        bodyDoorCloseModel[10] = new ModelRendererTurbo(this, 97, 255, textureX, textureY); // Box 91
        bodyDoorCloseModel[11] = new ModelRendererTurbo(this, 113, 255, textureX, textureY); // Box 94
        bodyDoorCloseModel[12] = new ModelRendererTurbo(this, 17, 263, textureX, textureY); // Box 95
        bodyDoorCloseModel[13] = new ModelRendererTurbo(this, 41, 263, textureX, textureY); // Box 96
        bodyDoorCloseModel[14] = new ModelRendererTurbo(this, 121, 255, textureX, textureY); // Box 97
        bodyDoorCloseModel[15] = new ModelRendererTurbo(this, 65, 263, textureX, textureY); // Box 98
        bodyDoorCloseModel[16] = new ModelRendererTurbo(this, 97, 263, textureX, textureY); // Box 99
        bodyDoorCloseModel[17] = new ModelRendererTurbo(this, 113, 263, textureX, textureY); // Box 104

        bodyDoorCloseModel[0].addShapeBox(-5.5F, -1.8F, -1F, 5, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 9

        bodyDoorCloseModel[1].addShapeBox(-9.5F, -0.8F, -1F, 4, 1, 2, 0F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.1F); // Box 10

        bodyDoorCloseModel[2].addShapeBox(-9.5F, -1.8F, -0.3F, 5, 2, 2, 0F, 0F, 0F, -1.8F, 0F, 0F, -1.8F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.8F, 0F, 0F, -1.8F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 11

        bodyDoorCloseModel[3].addShapeBox(-5.5F, -1.8F, 0.7F, 1, 2, 1, 0F, -0.4F, -0.3F, -0.3F, -0.4F, -0.3F, -0.3F, -0.4F, -0.3F, -0.1F, -0.4F, -0.3F, -0.1F, -0.4F, -0.3F, -0.3F, -0.4F, -0.3F, -0.3F, -0.4F, -0.3F, -0.1F, -0.4F, -0.3F, -0.1F); // Box 12

        bodyDoorCloseModel[4].addShapeBox(-0.5F, -1.8F, -1F, 4, 2, 2, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F); // Box 13

        bodyDoorCloseModel[5].addShapeBox(13.5F, -1.8F, -1F, 12, 2, 2, 0F, 0F, -0.2F, -0.2F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.2F, -0.2F); // Box 14

        bodyDoorCloseModel[6].addShapeBox(25.5F, -1.8F, -1F, 1, 2, 2, 0F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F, 0F, -0.4F, -0.4F); // Box 76

        bodyDoorCloseModel[7].addShapeBox(-9.5F, -2F, -1F, 4, 2, 1, 0F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.8F, 0F, -0.8F, -0.8F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.8F, 0F, 0F, -0.8F); // Box 81

        bodyDoorCloseModel[8].addShapeBox(-9.5F, -2F, 0.7F, 4, 2, 1, 0F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.1F, 0F, -0.8F, -0.8F, 0F, -0.8F, -0.8F, 0F, 0F, -0.1F, 0F, 0F, -0.1F, 0F, 0F, -0.8F, 0F, 0F, -0.8F); // Box 82

        bodyDoorCloseModel[9].addShapeBox(-2.5F, -2F, -1.5F, 5, 3, 3, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F); // Box 90

        bodyDoorCloseModel[10].addShapeBox(-2.5F, -3F, -0.5F, 5, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F); // Box 91

        bodyDoorCloseModel[11].addShapeBox(12.5F, -1.8F, -1F, 1, 2, 2, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, 0.1F, -0.1F, 0F, 0.1F, -0.1F, 0F, 0.1F, -0.1F, 0F, 0.1F, -0.1F); // Box 94

        bodyDoorCloseModel[12].addShapeBox(3.5F, -1.8F, -1F, 9, 2, 2, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F); // Box 95

        bodyDoorCloseModel[13].addShapeBox(6.5F, 0.2F, -1F, 7, 1, 2, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F); // Box 96

        bodyDoorCloseModel[14].addShapeBox(6.5F, -1.8F, -1F, 1, 2, 2, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, 0.1F, -0.1F, 0F, 0.1F, -0.1F, 0F, 0.1F, -0.1F, 0F, 0.1F, -0.1F); // Box 97

        bodyDoorCloseModel[15].addShapeBox(-0.5F, 1F, -0.5F, 15, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 98

        bodyDoorCloseModel[16].addShapeBox(-2.5F, 1F, -1.5F, 5, 1, 3, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 99

        bodyDoorCloseModel[17].addShapeBox(-1F, -1F, -2.5F, 2, 2, 5, 0F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F, -0.3F, -0.3F, 0.1F); // Box 104

        //Gun Origin
        for(ModelRendererTurbo gunPart : bodyDoorCloseModel)
        {
            gunPart.setRotationPoint(0F, -26F, 0F);
        }
    ...
    {
        for (ModelRendererTurbo modelRendererTurbo3 : bodyModel)
        {
            modelRendererTurbo3.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo2 : turretModel)
        {
            modelRendererTurbo2.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo1 : barrelModel)
        {
            modelRendererTurbo1.render(f5);
        }
        for (ModelRendererTurbo element : leftTrackModel)
        {
            element.render(f5);
        }
        for (ModelRendererTurbo item : rightTrackModel)
        {
            item.render(f5);
        }
        ...
        for (ModelRendererTurbo value : steeringWheelModel)
        {
            value.render(f5);
        }
        for (ModelRendererTurbo turbo : bodyDoorOpenModel)
        {
            turbo.render(f5);
        }
        for (ModelRendererTurbo rendererTurbo : trailerModel)
        {
            rendererTurbo.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo : bodyDoorCloseModel)
        {
