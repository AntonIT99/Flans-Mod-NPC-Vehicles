...
// Model: WW2_Vehicle_PanzerIV_2
// Model Creator: 
// Created on: 05.01.2016 - 10:08:09
// Last changed on: 05.01.2016 - 10:08:09
...
public class ModelPanzerIVH extends ModelVehicle //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
	...
	public ModelPanzerIVH() //Same as Filename
	{
		...
		bodyModel[135] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP1R
		bodyModel[136] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP2R
		bodyModel[137] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP3R
		bodyModel[138] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP4R
		bodyModel[139] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP1L
		bodyModel[140] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP2L
		bodyModel[141] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP3L
		bodyModel[142] = new ModelRendererTurbo(this, 250, 340, textureX, textureY); // Import BP4L
		bodyModel[143] = new ModelRendererTurbo(this, 0, 170, textureX, textureY); // Import 
		bodyModel[144] = new ModelRendererTurbo(this, 230, 165, textureX, textureY); // Import 
		bodyModel[145] = new ModelRendererTurbo(this, 425, 0, textureX, textureY); // Import Barrel
		
		bodyModel[146] = new ModelRendererTurbo(this, 425, 0, this.textureX, this.textureY);
	    
		bodyModel[146].addBox(-2.0F, -0.5F, -0.5F, 7, 1, 1, 0.0F);
	    bodyModel[146].setRotationPoint(42.5F, -19.5F, -11.5F);
		...
		bodyModel[135].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP1R
		bodyModel[135].setRotationPoint(-47F, -22F, 23F);

		bodyModel[136].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP2R
		bodyModel[136].setRotationPoint(-26F, -25.5F, 23F);

		bodyModel[137].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP3R
		bodyModel[137].setRotationPoint(-9F, -25.5F, 23F);

		bodyModel[138].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP4R
		bodyModel[138].setRotationPoint(15F, -25.5F, 23F);

		bodyModel[139].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP1L
		bodyModel[139].setRotationPoint(-47F, -22F, -31F);

		bodyModel[140].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP2L
		bodyModel[140].setRotationPoint(-26F, -25.5F, -31F);

		bodyModel[141].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP3L
		bodyModel[141].setRotationPoint(-5F, -25.5F, -31F);

		bodyModel[142].addBox(0F, 0F, 0F, 1, 1, 8, 0F); // Import BP4L
		bodyModel[142].setRotationPoint(15F, -25.5F, -31F);

		bodyModel[143].addShape3D(0F, 0F, 0F, new Shape2D(new Coord2D[] { new Coord2D(0, 11, 0, 11), new Coord2D(7, 5, 7, 5), new Coord2D(29, 0, 29, 0), new Coord2D(94, 0, 94, 0), new Coord2D(113, 5, 113, 5), new Coord2D(113, 24, 113, 24), new Coord2D(86, 28, 86, 28), new Coord2D(36, 28, 36, 28), new Coord2D(7, 23, 7, 23), new Coord2D(0, 17, 0, 17) }), 1, 113, 28, 261, 1, ModelRendererTurbo.MR_FRONT, new float[] {6 ,10 ,30 ,50 ,28 ,19 ,20 ,65 ,23 ,10}); // Import 
		bodyModel[143].setRotationPoint(63F, 2F, 32F);

		bodyModel[144].addShape3D(0F, 0F, 0F, new Shape2D(new Coord2D[] { new Coord2D(0, 11, 0, 11), new Coord2D(7, 5, 7, 5), new Coord2D(29, 0, 29, 0), new Coord2D(94, 0, 94, 0), new Coord2D(113, 5, 113, 5), new Coord2D(113, 24, 113, 24), new Coord2D(86, 28, 86, 28), new Coord2D(36, 28, 36, 28), new Coord2D(7, 23, 7, 23), new Coord2D(0, 17, 0, 17) }), 1, 113, 28, 261, 1, ModelRendererTurbo.MR_FRONT, new float[] {6 ,10 ,30 ,50 ,28 ,19 ,20 ,65 ,23 ,10}); // Import 
		bodyModel[144].setRotationPoint(63F, 2F, -31F);

		bodyModel[145].addBox(-2F, -0.5F, -0.5F, 7, 1, 1, 0F); // Import Barrel
		...
		turretModel[8] = new ModelRendererTurbo(this, 235, 370, textureX, textureY); // Import TP1
		turretModel[9] = new ModelRendererTurbo(this, 260, 370, textureX, textureY); // Import TP2
		turretModel[10] = new ModelRendererTurbo(this, 310, 343, textureX, textureY); // Import TP3
		turretModel[11] = new ModelRendererTurbo(this, 370, 370, textureX, textureY); // Import TP4
		turretModel[12] = new ModelRendererTurbo(this, 395, 343, textureX, textureY); // Import TP5
		turretModel[13] = new ModelRendererTurbo(this, 455, 370, textureX, textureY); // Import TP6
		turretModel[14] = new ModelRendererTurbo(this, 345, 325, textureX, textureY); // Import TP7
		turretModel[15] = new ModelRendererTurbo(this, 262, 350, textureX, textureY); // Import TP8
		turretModel[16] = new ModelRendererTurbo(this, 237, 350, textureX, textureY); // Import TP9
		turretModel[17] = new ModelRendererTurbo(this, 315, 350, textureX, textureY); // Import TP10
		turretModel[18] = new ModelRendererTurbo(this, 315, 350, textureX, textureY); // Import TP11
		turretModel[19] = new ModelRendererTurbo(this, 315, 350, textureX, textureY); // Import TP12
		turretModel[20] = new ModelRendererTurbo(this, 315, 350, textureX, textureY); // Import TP13
		turretModel[21] = new ModelRendererTurbo(this, 315, 350, textureX, textureY); // Import TP14
		turretModel[22] = new ModelRendererTurbo(this, 315, 350, textureX, textureY); // Import TP15
		...
		turretModel[8].addBox(0F, 0F, 0F, 10, 14, 1, 0F); // Import TP1
		turretModel[8].setRotationPoint(23F, -40F, -19F);
		turretModel[8].rotateAngleY = 1.134464F;

		turretModel[9].addBox(0F, 0F, 0F, 23, 14, 1, 0F); // Import TP2
		turretModel[9].setRotationPoint(0F, -40F, -22F);
		turretModel[9].rotateAngleY = 0.1361357F;

		turretModel[10].addBox(0F, 0F, 0F, 1, 14, 28, 0F); // Import TP3
		turretModel[10].setRotationPoint(0F, -40F, -22F);
		turretModel[10].rotateAngleY = 1.37881F;

		turretModel[11].addBox(0F, 0F, 0F, 9, 14, 1, 0F); // Import TP4
		turretModel[11].setRotationPoint(-36F, -40F, -14F);
		turretModel[11].rotateAngleY = -0.28797932F;

		turretModel[12].addBox(0F, 0F, 0F, 1, 14, 28, 0F); // Import TP5
		turretModel[12].setRotationPoint(-36F, -40F, -14F);

		turretModel[13].addBox(0F, 0F, -1F, 9, 14, 1, 0F); // Import TP6
		turretModel[13].setRotationPoint(-36F, -40F, 14F);
		turretModel[13].rotateAngleY = 0.28797932F;

		turretModel[14].addBox(-1F, 0F, 0F, 1, 14, 28, 0F); // Import TP7
		turretModel[14].setRotationPoint(0F, -40F, 22F);
		turretModel[14].rotateAngleY = 1.76278254F;

		turretModel[15].addBox(0F, 0F, -1F, 23, 14, 1, 0F); // Import TP8
		turretModel[15].setRotationPoint(0F, -40F, 22F);
		turretModel[15].rotateAngleY = -0.1361357F;

		turretModel[16].addBox(0F, 0F, -1F, 10, 14, 1, 0F); // Import TP9
		turretModel[16].setRotationPoint(23F, -40F, 19F);
		turretModel[16].rotateAngleY = -1.134464F;

		turretModel[17].addBox(0F, 0F, 0F, 1, 1, 9, 0F); // Import TP10
		turretModel[17].setRotationPoint(16F, -39.5F, 10F);
		turretModel[17].rotateAngleY = -0.1361357F;

		turretModel[18].addBox(0F, 0F, 0F, 1, 1, 9, 0F); // Import TP11
		turretModel[18].setRotationPoint(0F, -39.5F, 12.5F);
		turretModel[18].rotateAngleY = -0.1361357F;

		turretModel[19].addBox(0F, 0F, 0F, 1, 1, 9, 0F); // Import TP12
		turretModel[19].setRotationPoint(-14F, -39.5F, 9.5F);
		turretModel[19].rotateAngleY = 0.2268928F;

		turretModel[20].addBox(0F, 0F, -9F, 1, 1, 9, 0F); // Import TP13
		turretModel[20].setRotationPoint(-14F, -39.5F, -9.5F);
		turretModel[20].rotateAngleY = -0.2268928F;

		turretModel[21].addBox(0F, 0F, -9F, 1, 1, 9, 0F); // Import TP14
		turretModel[21].setRotationPoint(0F, -39.5F, -12.5F);
		turretModel[21].rotateAngleY = 0.1361357F;

		turretModel[22].addBox(0F, 0F, -9F, 1, 1, 9, 0F); // Import TP15
		turretModel[22].setRotationPoint(16F, -39.5F, -10F);
