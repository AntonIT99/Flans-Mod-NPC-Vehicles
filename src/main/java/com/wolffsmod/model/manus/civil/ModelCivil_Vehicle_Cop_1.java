...
public class ModelCivil_Vehicle_Cop_1 extends ModelFlanVehicle
{
    int textureX;
    int textureY;
    ...
    public ModelCivil_Vehicle_Cop_1() {
        ...
        this.bodyModel[19] = new ModelRendererTurbo((ModelBase)this, 0, 188, this.textureX, this.textureY);
