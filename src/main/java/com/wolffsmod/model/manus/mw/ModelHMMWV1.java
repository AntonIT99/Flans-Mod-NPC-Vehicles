...
public class ModelHMMWV1 extends ModelFlanVehicle
{
    int textureX;
    int textureY;
    ...
    public ModelHMMWV1() {
        this.textureX = 512;
        this.textureY = 512;
        (this.bodyModel = new ModelRendererTurbo[43])[0] = new ModelRendererTurbo((ModelBase)this, 84, 166, this.textureX, this.textureY);
