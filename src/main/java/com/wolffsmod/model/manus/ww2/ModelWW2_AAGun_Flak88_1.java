...
public class ModelWW2_AAGun_Flak88_1 extends ModelFlanAAGun
{
    int textureX;
    int textureY;
    ...
    public ModelWW2_AAGun_Flak88_1() {
        ...
        (this.seatModel = new ModelRendererTurbo[13])[0] = new ModelRendererTurbo((ModelBase)this, 0, 0, this.textureX, this.textureY);
