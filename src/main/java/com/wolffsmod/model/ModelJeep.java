...
public class ModelJeep extends ModelVehicle //Same as Filename
{
    ...
    public ModelJeep() //Same as Filename
    {
        ...
        turretModel[0] = new ModelRendererTurbo(this, 76, 10, textureX, textureY); // Box 4
        turretModel[1] = new ModelRendererTurbo(this, 76, 18, textureX, textureY); // Box 7
        turretModel[2] = new ModelRendererTurbo(this, 76, 26, textureX, textureY); // Box 8
        turretModel[3] = new ModelRendererTurbo(this, 100, 10, textureX, textureY); // Box 9
        turretModel[4] = new ModelRendererTurbo(this, 100, 18, textureX, textureY); // Box 10
        turretModel[5] = new ModelRendererTurbo(this, 100, 26, textureX, textureY); // Box 11
        turretModel[6] = new ModelRendererTurbo(this, 92, 34, textureX, textureY); // Box 13
        turretModel[7] = new ModelRendererTurbo(this, 100, 34, textureX, textureY); // Box 14

        turretModel[0].addShapeBox(-6F, -2.3F, -1F, 7, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F); // Box 4

        turretModel[1].addShapeBox(0.5F, -1.8F, -0.5F, 10, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 7

        turretModel[2].addShapeBox(1F, -1.8F, -0.5F, 10, 1, 1, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F); // Box 8

        turretModel[3].addShapeBox(-7.5F, -1.3F, -0.5F, 2, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 9

        turretModel[4].addShapeBox(-7.5F, -1.3F, -0.5F, 1, 3, 1, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 1F, -0.2F, -0.2F, -1F, -0.2F, -0.2F, -1F, -0.2F, -0.2F, 1F, -0.2F, -0.2F); // Box 10

        turretModel[5].addShapeBox(-0.1F, -3F, -0.5F, 1, 1, 1, 0F, -0.9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 0F, 0F, -0.9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 0F, 0F); // Box 11

        turretModel[6].addShapeBox(-5.5F, -2.5F, -0.5F, 2, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 13

        turretModel[7].addShapeBox(-5.5F, -3.25F, -0.5F, 1, 1, 1, 0F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F); // Box 14
        ...
        trailerModel[0] = new ModelRendererTurbo(this, 76, 34, textureX, textureY); // Box 299

        trailerModel[0].addShapeBox(-4.5F, -1.7F, 1F, 4, 2, 3, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0.5F, -0.6F, 0F, 0.5F, -0.6F, 0.5F, 0F, -0.6F, 0.5F, 0F, -0.6F, 0.5F, 0.5F, -0.6F, 0.5F, 0.5F); // Box 299
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        for (ModelRendererTurbo modelRendererTurbo1 : bodyDoorCloseModel)
        {
            modelRendererTurbo1.render(f5);
        }
        for (ModelRendererTurbo element : leftFrontWheelModel)
        {
            element.render(f5);
        }
        for (ModelRendererTurbo item : rightFrontWheelModel)
        {
            item.render(f5);
        }
        for (ModelRendererTurbo value : leftBackWheelModel)
        {
            value.render(f5);
        }
        for (ModelRendererTurbo turbo : rightBackWheelModel)
        {
            turbo.render(f5);
        }
