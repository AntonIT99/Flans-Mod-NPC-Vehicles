  ...
  extends ModelVehicle
{
  ...
  public ModelM4A3() {
    ...
    bodyModel[245] = new ModelRendererTurbo(this, 425, 0, textureX, textureY);
    
    bodyModel[245].addBox(-2.0F, -0.5F, -0.5F, 7, 1, 1, 0.0F);
    bodyModel[245].setRotationPoint(45.0F, -17.5F, -9.5F);
    ...
    bodyModel[225].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(28.0D, 5.0D, 28, 5), new Coord2D(28.0D, 9.0D, 28, 9), new Coord2D(8.0D, 9.0D, 8, 9), new Coord2D(4.0D, 8.0D, 4, 8), new Coord2D(1.0D, 5.0D, 1, 5) }), 1.0F, 28, 9, 69, 1, 0, new float[] { 6.0F, 5.0F, 5.0F, 20.0F, 4.0F, 29.0F });
    bodyModel[225].setRotationPoint(60.0F, -6.0F, 28.5F);
    
    bodyModel[226].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(28.0D, 5.0D, 28, 5), new Coord2D(28.0D, 9.0D, 28, 9), new Coord2D(8.0D, 9.0D, 8, 9), new Coord2D(4.0D, 8.0D, 4, 8), new Coord2D(1.0D, 5.0D, 1, 5) }), 1.0F, 28, 9, 69, 1, 0, new float[] { 6.0F, 5.0F, 5.0F, 20.0F, 4.0F, 29.0F });
    bodyModel[226].setRotationPoint(60.0F, -6.0F, 15.5F);
    
    bodyModel[227].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(28.0D, 5.0D, 28, 5), new Coord2D(28.0D, 9.0D, 28, 9), new Coord2D(8.0D, 9.0D, 8, 9), new Coord2D(4.0D, 8.0D, 4, 8), new Coord2D(1.0D, 5.0D, 1, 5) }), 1.0F, 28, 9, 69, 1, 0, new float[] { 6.0F, 5.0F, 5.0F, 20.0F, 4.0F, 29.0F });
    bodyModel[227].setRotationPoint(60.0F, -6.0F, -14.5F);
    
    bodyModel[228].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(28.0D, 5.0D, 28, 5), new Coord2D(28.0D, 9.0D, 28, 9), new Coord2D(8.0D, 9.0D, 8, 9), new Coord2D(4.0D, 8.0D, 4, 8), new Coord2D(1.0D, 5.0D, 1, 5) }), 1.0F, 28, 9, 69, 1, 0, new float[] { 6.0F, 5.0F, 5.0F, 20.0F, 4.0F, 29.0F });
    bodyModel[228].setRotationPoint(60.0F, -6.0F, -27.5F);
    
    bodyModel[229].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 5.0D, 0, 5), new Coord2D(29.0D, 0.0D, 29, 0), new Coord2D(30.0D, 0.0D, 30, 0), new Coord2D(26.0D, 9.0D, 26, 9), new Coord2D(0.0D, 9.0D, 0, 9) }), 1.0F, 30, 9, 71, 1, 0, new float[] { 4.0F, 26.0F, 10.0F, 1.0F, 30.0F });
    bodyModel[229].setRotationPoint(-28.0F, -6.0F, 28.5F);
    
    bodyModel[230].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 5.0D, 0, 5), new Coord2D(29.0D, 0.0D, 29, 0), new Coord2D(30.0D, 0.0D, 30, 0), new Coord2D(26.0D, 9.0D, 26, 9), new Coord2D(0.0D, 9.0D, 0, 9) }), 1.0F, 30, 9, 71, 1, 0, new float[] { 4.0F, 26.0F, 10.0F, 1.0F, 30.0F });
    ...
    bodyModel[233].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(1.0D, 1.0D, 1, 1), new Coord2D(2.0D, 5.0D, 2, 5), new Coord2D(1.0D, 5.0D, 1, 5) }), 12.0F, 2, 5, 14, 12, 0, new float[] { 6.0F, 1.0F, 5.0F, 2.0F });
    bodyModel[233].setRotationPoint(60.0F, -6.0F, 27.5F);
    
    bodyModel[234].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(1.0D, 0.0D, 1, 0), new Coord2D(3.0D, 2.0D, 3, 2), new Coord2D(3.0D, 3.0D, 3, 3) }), 12.0F, 3, 3, 10, 12, 0, new float[] { 5.0F, 1.0F, 3.0F, 1.0F });
    bodyModel[234].setRotationPoint(59.0F, -11.0F, 27.5F);
    
    bodyModel[235].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(6.0D, 1.0D, 6, 1), new Coord2D(6.0D, 2.0D, 6, 2), new Coord2D(4.0D, 2.0D, 4, 2), new Coord2D(0.0D, 1.0D, 0, 1) }), 12.0F, 6, 2, 16, 12, 0, new float[] { 1.0F, 5.0F, 2.0F, 1.0F, 7.0F });
    bodyModel[235].setRotationPoint(56.0F, -13.0F, 27.5F);
    
    bodyModel[236].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(3.0D, 0.0D, 3, 0), new Coord2D(4.0D, 0.0D, 4, 0), new Coord2D(0.0D, 9.0D, 0, 9), new Coord2D(0.0D, 8.0D, 0, 8) }), 13.0F, 4, 9, 21, 13, 0, new float[] { 9.0F, 1.0F, 10.0F, 1.0F });
    bodyModel[236].setRotationPoint(-54.0F, -6.0F, 28.0F);
    
    bodyModel[237].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(1.0D, 1.0D, 1, 1), new Coord2D(2.0D, 5.0D, 2, 5), new Coord2D(1.0D, 5.0D, 1, 5) }), 12.0F, 2, 5, 14, 12, 0, new float[] { 6.0F, 1.0F, 5.0F, 2.0F });
    bodyModel[237].setRotationPoint(60.0F, -6.0F, -15.5F);
    
    bodyModel[238].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(1.0D, 0.0D, 1, 0), new Coord2D(3.0D, 2.0D, 3, 2), new Coord2D(3.0D, 3.0D, 3, 3) }), 12.0F, 3, 3, 10, 12, 0, new float[] { 5.0F, 1.0F, 3.0F, 1.0F });
    bodyModel[238].setRotationPoint(59.0F, -11.0F, -15.5F);
    
    bodyModel[239].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(6.0D, 1.0D, 6, 1), new Coord2D(6.0D, 2.0D, 6, 2), new Coord2D(4.0D, 2.0D, 4, 2), new Coord2D(0.0D, 1.0D, 0, 1) }), 12.0F, 6, 2, 16, 12, 0, new float[] { 1.0F, 5.0F, 2.0F, 1.0F, 7.0F });
    bodyModel[239].setRotationPoint(56.0F, -13.0F, -15.5F);
    
    bodyModel[240].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(3.0D, 0.0D, 3, 0), new Coord2D(4.0D, 0.0D, 4, 0), new Coord2D(0.0D, 9.0D, 0, 9), new Coord2D(0.0D, 8.0D, 0, 8) }), 13.0F, 4, 9, 21, 13, 0, new float[] { 9.0F, 1.0F, 10.0F, 1.0F });
    ...
    turretModel[1].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 2.0D, 0, 2), new Coord2D(5.0D, 0.0D, 5, 0), new Coord2D(7.0D, 0.0D, 7, 0), new Coord2D(12.0D, 1.0D, 12, 1), new Coord2D(29.0D, 7.0D, 29, 7), new Coord2D(29.0D, 33.0D, 29, 33), new Coord2D(12.0D, 39.0D, 12, 39), new Coord2D(7.0D, 40.0D, 7, 40), new Coord2D(5.0D, 40.0D, 5, 40), new Coord2D(0.0D, 38.0D, 0, 38) }), 15.0F, 29, 40, 128, 15, 0, new float[] { 36.0F, 6.0F, 2.0F, 6.0F, 19.0F, 26.0F, 19.0F, 6.0F, 2.0F, 6.0F });
    ...
    turretModel[9].addShape3D(8.5F, -8.5F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(5.0D, 0.0D, 5, 0), new Coord2D(12.0D, 0.0D, 12, 0), new Coord2D(17.0D, 5.0D, 17, 5), new Coord2D(17.0D, 12.0D, 17, 12), new Coord2D(12.0D, 17.0D, 12, 17), new Coord2D(5.0D, 17.0D, 5, 17), new Coord2D(0.0D, 12.0D, 0, 12), new Coord2D(0.0D, 5.0D, 0, 5) }), 3.0F, 17, 17, 60, 3, 0, new float[] { 8.0F, 7.0F, 8.0F, 7.0F, 8.0F, 7.0F, 8.0F, 7.0F });
    (turretModel[9]).rotateAngleX = 1.5707964F;
