...
public class ModelSASJeep extends ModelVehicle //Same as Filename
{
    ...
    public ModelSASJeep() //Same as Filename
    {
        ...
        turretModel[0] = new ModelRendererTurbo(this, 1, 306, textureX, textureY); // Import Barrel
        turretModel[1] = new ModelRendererTurbo(this, 1, 314, textureX, textureY); // Import FiringMechanism
        turretModel[2] = new ModelRendererTurbo(this, 49, 306, textureX, textureY); // Import Underbarrelhandle2
        turretModel[3] = new ModelRendererTurbo(this, 25, 314, textureX, textureY); // Import UnderBarrel
        turretModel[4] = new ModelRendererTurbo(this, 49, 314, textureX, textureY); // Import Trigger
        turretModel[5] = new ModelRendererTurbo(this, 57, 306, textureX, textureY); // Import RearSight
        turretModel[6] = new ModelRendererTurbo(this, 1, 322, textureX, textureY); // Import FrontSight
        turretModel[7] = new ModelRendererTurbo(this, 9, 322, textureX, textureY); // Import Pump
        turretModel[8] = new ModelRendererTurbo(this, 17, 322, textureX, textureY); // Box 0
        turretModel[9] = new ModelRendererTurbo(this, 25, 322, textureX, textureY); // Box 2
        turretModel[10] = new ModelRendererTurbo(this, 49, 322, textureX, textureY); // Box 3
        turretModel[11] = new ModelRendererTurbo(this, 1, 330, textureX, textureY); // Box 4
        turretModel[12] = new ModelRendererTurbo(this, 57, 322, textureX, textureY); // Box 5
        turretModel[13] = new ModelRendererTurbo(this, 17, 330, textureX, textureY); // Box 6
        turretModel[14] = new ModelRendererTurbo(this, 33, 330, textureX, textureY); // Box 7
        turretModel[15] = new ModelRendererTurbo(this, 1, 338, textureX, textureY); // Box 8
        turretModel[16] = new ModelRendererTurbo(this, 25, 338, textureX, textureY); // Box 9
        turretModel[17] = new ModelRendererTurbo(this, 57, 330, textureX, textureY); // Box 10
        turretModel[18] = new ModelRendererTurbo(this, 1, 306, textureX, textureY); // Box 0
        turretModel[19] = new ModelRendererTurbo(this, 1, 314, textureX, textureY); // Box 0
        turretModel[20] = new ModelRendererTurbo(this, 49, 306, textureX, textureY); // Box 0
        turretModel[21] = new ModelRendererTurbo(this, 25, 314, textureX, textureY); // Box 0
        turretModel[22] = new ModelRendererTurbo(this, 49, 314, textureX, textureY); // Box 0
        turretModel[23] = new ModelRendererTurbo(this, 57, 306, textureX, textureY); // Box 0
        turretModel[24] = new ModelRendererTurbo(this, 1, 322, textureX, textureY); // Box 0
        turretModel[25] = new ModelRendererTurbo(this, 9, 322, textureX, textureY); // Box 0
        turretModel[26] = new ModelRendererTurbo(this, 17, 322, textureX, textureY); // Box 0
        turretModel[27] = new ModelRendererTurbo(this, 25, 322, textureX, textureY); // Box 0
        turretModel[28] = new ModelRendererTurbo(this, 49, 322, textureX, textureY); // Box 0
        turretModel[29] = new ModelRendererTurbo(this, 1, 330, textureX, textureY); // Box 0
        turretModel[30] = new ModelRendererTurbo(this, 57, 322, textureX, textureY); // Box 0
        turretModel[31] = new ModelRendererTurbo(this, 17, 330, textureX, textureY); // Box 0
        turretModel[32] = new ModelRendererTurbo(this, 33, 330, textureX, textureY); // Box 0
        turretModel[33] = new ModelRendererTurbo(this, 1, 338, textureX, textureY); // Box 0
        turretModel[34] = new ModelRendererTurbo(this, 25, 338, textureX, textureY); // Box 0
        turretModel[35] = new ModelRendererTurbo(this, 57, 330, textureX, textureY); // Box 0
        turretModel[36] = new ModelRendererTurbo(this, 44, 334, textureX, textureY); // Box 18
        turretModel[37] = new ModelRendererTurbo(this, 44, 334, textureX, textureY); // Box 19

        turretModel[0].addBox(-7F, -1F, -4F, 22, 1, 1, 0F); // Import Barrel

        turretModel[1].addBox(-5F, -1.3F, -4.5F, 9, 2, 2, 0F); // Import FiringMechanism

        turretModel[2].addShapeBox(10F, -1.3F, -4.5F, 1, 3, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Import Underbarrelhandle2

        turretModel[3].addBox(1F, 0.1F, -4F, 10, 1, 1, 0F); // Import UnderBarrel

        turretModel[4].addBox(-7.2F, 1.2F, -4F, 4, 1, 1, 0F); // Import Trigger

        turretModel[5].addBox(-4F, -2.5F, -4F, 1, 1, 1, 0F); // Import RearSight

        turretModel[6].addBox(12F, -1.8F, -4F, 1, 1, 1, 0F); // Import FrontSight

        turretModel[7].addBox(1F, -0.800000000000001F, -3F, 1, 1, 1, 0F); // Import Pump

        turretModel[8].addBox(4F, -2.8F, -4F, 1, 2, 1, 0F); // Box 0

        turretModel[9].addBox(-5F, 0.7F, -4.5F, 8, 1, 2, 0F); // Box 2

        turretModel[10].addBox(-8F, -1F, -4F, 1, 4, 1, 0F); // Box 3

        turretModel[11].addBox(-12F, -1F, -4F, 4, 1, 1, 0F); // Box 4

        turretModel[12].addBox(-12F, 0F, -4F, 2, 2, 1, 0F); // Box 5

        turretModel[13].addBox(-12F, 2F, -4F, 4, 1, 1, 0F); // Box 6

        turretModel[14].addBox(-2.5F, -2.3F, -4.5F, 6, 1, 2, 0F); // Box 7

        turretModel[15].addShapeBox(-2.5F, -2.3F, -6.5F, 6, 1, 2, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 8

        turretModel[16].addShapeBox(-2.5F, -2.3F, -2.5F, 6, 1, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F); // Box 9

        turretModel[17].addBox(-4.2F, 1.2F, -4F, 2, 2, 1, 0F); // Box 10

        turretModel[18].addBox(-7F, -1F, 3F, 22, 1, 1, 0F); // Box 0

        turretModel[19].addBox(-5F, -1.3F, 2.5F, 9, 2, 2, 0F); // Box 0

        turretModel[20].addShapeBox(10F, -1.3F, 2.5F, 1, 3, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 0

        turretModel[21].addBox(1F, 0.1F, 3F, 10, 1, 1, 0F); // Box 0

        turretModel[22].addBox(-7.2F, 1.2F, 3F, 4, 1, 1, 0F); // Box 0

        turretModel[23].addBox(-4F, -2.5F, 3F, 1, 1, 1, 0F); // Box 0

        turretModel[24].addBox(12F, -1.8F, 3F, 1, 1, 1, 0F); // Box 0

        turretModel[25].addBox(1F, -0.800000000000001F, 4F, 1, 1, 1, 0F); // Box 0

        turretModel[26].addBox(10F, -3.8F, -0.5F, 1, 2, 1, 0F); // Box 0

        turretModel[27].addBox(-5F, 0.7F, 2.5F, 8, 1, 2, 0F); // Box 0

        turretModel[28].addBox(-8F, -1F, 3F, 1, 4, 1, 0F); // Box 0

        turretModel[29].addBox(-12F, -1F, 3F, 4, 1, 1, 0F); // Box 0

        turretModel[30].addBox(-12F, 0F, 3F, 2, 2, 1, 0F); // Box 0

        turretModel[31].addBox(-12F, 2F, 3F, 4, 1, 1, 0F); // Box 0

        turretModel[32].addBox(-2.5F, -2.3F, 2.5F, 6, 1, 2, 0F); // Box 0

        turretModel[33].addShapeBox(-2.5F, -2.3F, 0.5F, 6, 1, 2, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 0

        turretModel[34].addShapeBox(-2.5F, -2.3F, 4.5F, 6, 1, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F); // Box 0

        turretModel[35].addBox(-4.2F, 1.2F, 3F, 2, 2, 1, 0F); // Box 0

        turretModel[36].addBox(10F, -1.8F, -4F, 1, 1, 8, 0F); // Box 18

        turretModel[37].addBox(-1F, 1.2F, -4F, 1, 1, 8, 0F); // Box 19
        ...
        rightTrackModel[0] = new ModelRendererTurbo(this, 2, 347, textureX, textureY); // Box 4
        rightTrackModel[1] = new ModelRendererTurbo(this, 2, 355, textureX, textureY); // Box 7
        rightTrackModel[2] = new ModelRendererTurbo(this, 2, 363, textureX, textureY); // Box 8
        rightTrackModel[3] = new ModelRendererTurbo(this, 26, 347, textureX, textureY); // Box 9
        rightTrackModel[4] = new ModelRendererTurbo(this, 26, 355, textureX, textureY); // Box 10
        rightTrackModel[5] = new ModelRendererTurbo(this, 26, 363, textureX, textureY); // Box 11
        rightTrackModel[6] = new ModelRendererTurbo(this, 18, 371, textureX, textureY); // Box 13
        rightTrackModel[7] = new ModelRendererTurbo(this, 26, 371, textureX, textureY); // Box 14

        rightTrackModel[0].addShapeBox(-6F, -2.3F, -1F, 7, 2, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F); // Box 4

        rightTrackModel[1].addShapeBox(0.5F, -1.8F, -0.5F, 10, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 7

        rightTrackModel[2].addShapeBox(1F, -1.8F, -0.5F, 10, 1, 1, 0F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F); // Box 8

        rightTrackModel[3].addShapeBox(-7.5F, -1.3F, -0.5F, 2, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 9

        rightTrackModel[4].addShapeBox(-7.5F, -1.3F, -0.5F, 1, 3, 1, 0F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 1F, -0.2F, -0.2F, -1F, -0.2F, -0.2F, -1F, -0.2F, -0.2F, 1F, -0.2F, -0.2F); // Box 10

        rightTrackModel[5].addShapeBox(-0.1F, -3F, -0.5F, 1, 1, 1, 0F, -0.9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 0F, 0F, -0.9F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.9F, 0F, 0F); // Box 11

        rightTrackModel[6].addShapeBox(-5.5F, -2.5F, -0.5F, 2, 1, 1, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 13

        rightTrackModel[7].addShapeBox(-5.5F, -3.25F, -0.5F, 1, 1, 1, 0F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F, -0.4F, -0.2F, -0.2F); // Box 14

        //Gun Origin
        for(ModelRendererTurbo gunPart : rightTrackModel)
        {
        ...
        leftTrackModel[0] = new ModelRendererTurbo(this, 2, 371, textureX, textureY); // Box 299

        leftTrackModel[0].addShapeBox(-4.5F, -1.7F, 1F, 4, 2, 3, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, 0.5F, -0.6F, 0F, 0.5F, -0.6F, 0.5F, 0F, -0.6F, 0.5F, 0F, -0.6F, 0.5F, 0.5F, -0.6F, 0.5F, 0.5F); // Box 299

        //Gun Origin
        for(ModelRendererTurbo gunPart : leftTrackModel)
        {
            gunPart.setRotationPoint(-15F, -30F, -13F);
        }
        ...
        rightTrackWheelModels[0] = new ModelRendererTurbo(this, 1, 306, textureX, textureY); // Import Barrel
        rightTrackWheelModels[1] = new ModelRendererTurbo(this, 1, 314, textureX, textureY); // Import FiringMechanism
        rightTrackWheelModels[2] = new ModelRendererTurbo(this, 49, 306, textureX, textureY); // Import Underbarrelhandle2
        rightTrackWheelModels[3] = new ModelRendererTurbo(this, 25, 314, textureX, textureY); // Import UnderBarrel
        rightTrackWheelModels[4] = new ModelRendererTurbo(this, 49, 314, textureX, textureY); // Import Trigger
        rightTrackWheelModels[5] = new ModelRendererTurbo(this, 57, 306, textureX, textureY); // Import RearSight
        rightTrackWheelModels[6] = new ModelRendererTurbo(this, 1, 322, textureX, textureY); // Import FrontSight
        rightTrackWheelModels[7] = new ModelRendererTurbo(this, 9, 322, textureX, textureY); // Import Pump
        rightTrackWheelModels[8] = new ModelRendererTurbo(this, 17, 322, textureX, textureY); // Box 0
        rightTrackWheelModels[9] = new ModelRendererTurbo(this, 25, 322, textureX, textureY); // Box 2
        rightTrackWheelModels[10] = new ModelRendererTurbo(this, 49, 322, textureX, textureY); // Box 3
        rightTrackWheelModels[11] = new ModelRendererTurbo(this, 1, 330, textureX, textureY); // Box 4
        rightTrackWheelModels[12] = new ModelRendererTurbo(this, 57, 322, textureX, textureY); // Box 5
        rightTrackWheelModels[13] = new ModelRendererTurbo(this, 17, 330, textureX, textureY); // Box 6
        rightTrackWheelModels[14] = new ModelRendererTurbo(this, 33, 330, textureX, textureY); // Box 7
        rightTrackWheelModels[15] = new ModelRendererTurbo(this, 1, 338, textureX, textureY); // Box 8
        rightTrackWheelModels[16] = new ModelRendererTurbo(this, 25, 338, textureX, textureY); // Box 9
        rightTrackWheelModels[17] = new ModelRendererTurbo(this, 57, 330, textureX, textureY); // Box 10

        rightTrackWheelModels[0].addBox(-7F, -1F, -0.5F, 22, 1, 1, 0F); // Import Barrel

        rightTrackWheelModels[1].addBox(-5F, -1.3F, -1F, 9, 2, 2, 0F); // Import FiringMechanism

        rightTrackWheelModels[2].addShapeBox(10F, -1.3F, -1F, 1, 3, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Import Underbarrelhandle2

        rightTrackWheelModels[3].addBox(1F, 0.1F, -0.5F, 10, 1, 1, 0F); // Import UnderBarrel

        rightTrackWheelModels[4].addBox(-7.2F, 1.2F, -0.5F, 4, 1, 1, 0F); // Import Trigger

        rightTrackWheelModels[5].addBox(-4F, -2.5F, -0.5F, 1, 1, 1, 0F); // Import RearSight

        rightTrackWheelModels[6].addBox(12F, -1.8F, -0.5F, 1, 1, 1, 0F); // Import FrontSight

        rightTrackWheelModels[7].addBox(1F, -0.800000000000001F, 0.5F, 1, 1, 1, 0F); // Import Pump

        rightTrackWheelModels[8].addBox(4F, -2.8F, -0.5F, 1, 2, 1, 0F); // Box 0

        rightTrackWheelModels[9].addBox(-5F, 0.7F, -1F, 8, 1, 2, 0F); // Box 2

        rightTrackWheelModels[10].addBox(-8F, -1F, -0.5F, 1, 4, 1, 0F); // Box 3

        rightTrackWheelModels[11].addBox(-12F, -1F, -0.5F, 4, 1, 1, 0F); // Box 4

        rightTrackWheelModels[12].addBox(-12F, 0F, -0.5F, 2, 2, 1, 0F); // Box 5

        rightTrackWheelModels[13].addBox(-12F, 2F, -0.5F, 4, 1, 1, 0F); // Box 6

        rightTrackWheelModels[14].addBox(-2.5F, -2.3F, -1F, 6, 1, 2, 0F); // Box 7

        rightTrackWheelModels[15].addShapeBox(-2.5F, -2.3F, -3F, 6, 1, 2, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 8

        rightTrackWheelModels[16].addShapeBox(-2.5F, -2.3F, 1F, 6, 1, 2, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0F, 0F); // Box 9

        rightTrackWheelModels[17].addBox(-4.2F, 1.2F, -0.5F, 2, 2, 1, 0F); // Box 10
    ...
    {
        for (ModelRendererTurbo modelRendererTurbo5 : bodyModel)
        {
            modelRendererTurbo5.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo4 : turretModel)
        {
            modelRendererTurbo4.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo3 : bodyDoorCloseModel)
        {
            modelRendererTurbo3.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo2 : leftFrontWheelModel)
        {
            modelRendererTurbo2.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo1 : rightFrontWheelModel)
        {
            modelRendererTurbo1.render(f5);
        }
        for (ModelRendererTurbo element : leftBackWheelModel)
        {
            element.render(f5);
        }
        for (ModelRendererTurbo item : rightBackWheelModel)
        {
            item.render(f5);
        }
        ...
        for (ModelRendererTurbo turbo : trailerModel)
        {
            turbo.render(f5);
        }
        ...
        for (ModelRendererTurbo rendererTurbo : rightTrackModel)
        {
