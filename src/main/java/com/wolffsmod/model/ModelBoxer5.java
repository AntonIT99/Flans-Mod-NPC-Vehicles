        ...
        extends ModelVehicle
{
    ...
    (bodyModel[56]).rotateAngleZ = -0.08726646F;*/
        ...
        (turretModel[9]).rotateAngleY = 3.1415927F;
        ...
        turretModel[11].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(34.0D, 0.0D, 34, 0), new Coord2D(34.0D, 6.0D, 34, 6), new Coord2D(32.0D, 8.0D, 32, 8), new Coord2D(14.0D, 8.0D, 14, 8) }), 12.0F, 34, 8, 78, 12, 0, new float[] { 17.0F, 18.0F, 3.0F, 6.0F, 34.0F });
        turretModel[11].setRotationPoint(14.0F, -39.0F, 16.0F);

        turretModel[12].addShape3D(0.0F, 0.0F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(0.0D, 0.0D, 0, 0), new Coord2D(34.0D, 0.0D, 34, 0), new Coord2D(34.0D, 6.0D, 34, 6), new Coord2D(32.0D, 8.0D, 32, 8), new Coord2D(14.0D, 8.0D, 14, 8) }), 12.0F, 34, 8, 78, 12, 0, new float[] { 17.0F, 18.0F, 3.0F, 6.0F, 34.0F });
    ...
    {
        for (ModelRendererTurbo rendererTurbo : bodyModel)
        {
            rendererTurbo.render(f5);
        }
        for (ModelRendererTurbo rendererTurbo : turretModel)
        {
            rendererTurbo.render(f5);
        }
        for (ModelRendererTurbo rendererTurbo : barrelModel)
        {
            rendererTurbo.render(f5);
        }
        for (ModelRendererTurbo rendererTurbo : leftFrontWheelModel)
        {
            rendererTurbo.render(f5);
        }
        for (ModelRendererTurbo rendererTurbo : rightFrontWheelModel)
        {
            rendererTurbo.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo : leftBackWheelModel)
        {
