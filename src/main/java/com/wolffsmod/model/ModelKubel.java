...
public class ModelKubel extends ModelVehicle //Same as Filename
{
    ...
    public ModelKubel() //Same as Filename
    {
        ...
        turretModel[0] = new ModelRendererTurbo(this, 9, 227, textureX, textureY); // Box 4
        turretModel[1] = new ModelRendererTurbo(this, 41, 227, textureX, textureY); // Box 5
        turretModel[2] = new ModelRendererTurbo(this, 1, 235, textureX, textureY); // Box 6
        turretModel[3] = new ModelRendererTurbo(this, 57, 227, textureX, textureY); // Box 7
        turretModel[4] = new ModelRendererTurbo(this, 17, 235, textureX, textureY); // Box 8
        turretModel[5] = new ModelRendererTurbo(this, 25, 235, textureX, textureY); // Box 9
        turretModel[6] = new ModelRendererTurbo(this, 33, 235, textureX, textureY); // Box 10
        turretModel[7] = new ModelRendererTurbo(this, 41, 235, textureX, textureY); // Box 12
        turretModel[8] = new ModelRendererTurbo(this, 49, 235, textureX, textureY); // Box 13
        turretModel[9] = new ModelRendererTurbo(this, 1, 243, textureX, textureY); // Box 15
        turretModel[10] = new ModelRendererTurbo(this, 9, 243, textureX, textureY); // Box 16
        turretModel[11] = new ModelRendererTurbo(this, 17, 243, textureX, textureY); // Box 17
        turretModel[12] = new ModelRendererTurbo(this, 25, 243, textureX, textureY); // Box 18
        turretModel[13] = new ModelRendererTurbo(this, 33, 227, textureX, textureY); // Box 19
        turretModel[14] = new ModelRendererTurbo(this, 1, 251, textureX, textureY); // Box 0
        turretModel[15] = new ModelRendererTurbo(this, 49, 243, textureX, textureY); // Box 1
    ...
    {
        for (ModelRendererTurbo modelRendererTurbo2 : bodyModel)
        {
            modelRendererTurbo2.render(f5);
        }
        for (ModelRendererTurbo modelRendererTurbo1 : turretModel)
        {
            modelRendererTurbo1.render(f5);
        }
        for (ModelRendererTurbo element : bodyDoorCloseModel)
        {
            element.render(f5);
        }
        for (ModelRendererTurbo item : leftFrontWheelModel)
        {
            item.render(f5);
        }
