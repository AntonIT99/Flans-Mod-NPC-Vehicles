package com.wolffsmod.model.official.titan;

import com.flansmod.client.tmt.Coord2D;
import com.flansmod.client.tmt.ModelRendererTurbo;
import com.flansmod.client.tmt.Shape2D;
import com.flansmod.common.vector.Vector3f;
import com.wolffsmod.model.ModelFlanMecha;

public class ModelProtoTitan extends ModelFlanMecha
{
	public ModelProtoTitan()
	{
		...
		bodyModel[3].addShapeBox(-12F, 29F, -11.5F, 16, 19, 23, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F, -0.1F, -0.1F, 0F); // interior
		bodyModel[3].setRotationPoint(0F, 0F, 0F);
		
		bodyModel[4] = new ModelRendererTurbo(this, 203, 0, textureX, textureY);
		bodyModel[4].addShape3D(0.01F, 21, 11.5F, new Shape2D(new Coord2D[]{new Coord2D(4, 8, 0, 0), new Coord2D(4, 27, 0, 19), new Coord2D(12, 18, 8, 10), new Coord2D(12, 8, 8, 0)}), 23, 8, 19, 49, 24, ModelRendererTurbo.MR_BACK, new float[]{8, 10, 12, 19});
		
		bodyModel[5] = new ModelRendererTurbo(this, 0, 52, textureX, textureY);
		bodyModel[5].addShape3D(0.01F, 21, 11.5F, new Shape2D(new Coord2D[]{new Coord2D(-12, 2, 0, 0), new Coord2D(-12, 8, 0, 6), new Coord2D(12, 8, 24, 6), new Coord2D(9, 2, 21, 0)}), 23, 24, 6, 61, 24, ModelRendererTurbo.MR_BACK, new float[]{20, 9, 24, 8});
