...
public class ModelT34_85 extends ModelVehicle
{
  int textureX = 512;
  int textureY = 512;
  ...
  public ModelT34_85() {
    ...
    bodyModel[70] = new ModelRendererTurbo(this, 425, 0, textureX, textureY);
    bodyModel[70].addBox(-2.0F, -0.5F, -0.5F, 7, 1, 1, 0.0F);
    bodyModel[70].setRotationPoint(32.0F, -14.5F, -10.5F);
    ...
    (bodyModel[58]).rotateAngleY = -1.5707964F;
    ...
    (turretModel[0]).rotateAngleX = 1.5707964F;
    ...
    (turretModel[4]).rotateAngleY = 3.1415927F;
    ...
    turretModel[7].addShape3D(7.5F, -7.5F, 0.0F, new Shape2D(new Coord2D[] { new Coord2D(4.0D, 0.0D, 4, 0), new Coord2D(11.0D, 0.0D, 11, 0), new Coord2D(15.0D, 4.0D, 15, 4), new Coord2D(15.0D, 11.0D, 15, 11), new Coord2D(11.0D, 15.0D, 11, 15), new Coord2D(4.0D, 15.0D, 4, 15), new Coord2D(0.0D, 11.0D, 0, 11), new Coord2D(0.0D, 4.0D, 0, 4) }), 3.0F, 15, 15, 52, 3, 0, new float[] { 6.0F, 7.0F, 6.0F, 7.0F, 6.0F, 7.0F, 6.0F, 7.0F });
