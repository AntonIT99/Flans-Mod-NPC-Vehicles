...
public class ModelBF109Kai extends ModelFlanPlane
{
    public ModelBF109Kai() {
        ...
        (this.bayModel[0] = new ModelRendererTurbo((ModelBase)this, 0, 0, textureX, textureY)).addTrapezoid(17.0f, -16.0f, -10.0f, 76, 18, 20, 0.0f, -3.0f, 2);
        ...
        (this.rightWingModel = new ModelRendererTurbo[2])[0] = new ModelRendererTurbo((ModelBase)this, 58, 48, textureX, textureY);
        this.rightWingModel[1] = new ModelRendererTurbo((ModelBase)this, 172, 0, textureX, textureY);
        this.rightWingModel[0].addBox(-25.0f, 3.0f, 0.0f, 32, 2, 78, 0.0f);
        this.rightWingModel[1].addTrapezoid(-25.0f, 3.0f, 78.0f, 32, 2, 10, 0.0f, -1.0f, 1);
        (this.leftWingModel = new ModelRendererTurbo[2])[0] = new ModelRendererTurbo((ModelBase)this, 58, 48, textureX, textureY);
