...
public class EntitySmallSmoke extends EntityFX
{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        float scale = 2.5F + (this.particleAge * 0.01F);
        float xPos = (float) (this.prevPosX + 0.0001*(this.posX - this.prevPosX) * (double) par2 - interpPosX);
        float yPos = (float) (this.prevPosY + 0.00001*(this.posY - this.prevPosY) * (double) par2 - interpPosY);
        ...
        par1Tessellator.setColorRGBA_F(this.particleRed * colorIntensity, this.particleGreen * colorIntensity, this.particleBlue * colorIntensity, (1F - this.particleAge*this.particleAge*this.particleAge*0.000000321F));
