	 ...
	 public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
	    {
	        ...
	        float scale = 0.1F + ((this.particleAge)*12F) - ((this.particleAge)*(this.particleAge)*1.5F);
	        ...
	        par1Tessellator.setColorRGBA_F(this.particleRed * colorIntensity, this.particleGreen * (0F), this.particleBlue * (0F), (1F - this.particleAge*this.particleAge*this.particleAge*0.0009F));
