...
extends ModelGun {
    public ModelFRF2() {
        ...
        this.gunModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/FRF2_body.obj");
        this.gunModel[0].setRotationPoint(3.5f, 2.0f, 0.0f);
        this.ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        this.ammoModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/FRF2_magazine.obj");
        this.ammoModel[0].setRotationPoint(3.5f, 2.0f, 0.0f);
        this.pumpModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        this.pumpModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/FRF2_cock.obj");
