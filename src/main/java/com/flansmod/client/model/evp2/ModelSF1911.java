...
extends ModelGun {
    public ModelSF1911() {
        ...
        this.gunModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/sf1911_body.obj");
        this.gunModel[0].setRotationPoint(3.5f, 2.0f, 0.0f);
        this.ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        this.ammoModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/sf1911_magazine.obj");
        this.ammoModel[0].setRotationPoint(3.5f, 2.0f, 0.0f);
        this.slideModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        this.slideModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/sf1911_slide.obj");
