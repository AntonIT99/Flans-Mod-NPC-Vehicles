...
public class ModelChinaCrossbow extends ModelGun //Same as Filename
{
	int textureX = 64;
	int textureY = 64;

	public ModelChinaCrossbow() //Same as Filename
	{
	...
	private void initgunModel_1()
	{
		...
		gunModel[11].setRotationPoint(16.2F, -2.5F, -2.7F);
		...
		gunModel[12].setRotationPoint(16.4F, -2.5F, 6.3F);
		...
		gunModel[13].setRotationPoint(16.4F, -2.5F, -6.3F);
	...
	private void initammoModel_1()
	{
	    ...
	    leftArmRot = new Vector3f(70.0F, 40.0F, 0.0F);
	    leftArmReloadPos = new Vector3f(-0.3F, -0.65F, 0.0F);
	    leftArmReloadRot = new Vector3f(70.0F, 30.0F, 10.0F);
	    rightArmChargePos = new Vector3f(-0.18F, 0.5F, -0.1F);
	    rightArmChargeRot = new Vector3f(0.0F, 0.0F, -90.0F);
	    rightArmPos = new Vector3f(0.3F, -0.9F, 0.0F);
	    rightArmRot = new Vector3f(0.0F, 0.0F, -90.0F);
	    rightArmReloadPos = new Vector3f(0.3F, -0.8F, 0.0F);
