...
public class ModelCloseHelmOpen extends ModelCustomArmour //Same as Filename
{
	int textureX = 128;
	int textureY = 64;

	public ModelCloseHelmOpen() //Same as Filename
	{
	...
	private void initheadModel_1()
	{
		...
		headModel[57] = new ModelRendererTurbo(this, 97, 1, textureX, textureY); // Box 57
		headModel[58] = new ModelRendererTurbo(this, 121, 1, textureX, textureY); // Box 58
		headModel[59] = new ModelRendererTurbo(this, 1, 9, textureX, textureY); // Box 59
		headModel[60] = new ModelRendererTurbo(this, 57, 9, textureX, textureY); // Box 60
		headModel[61] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 75
		headModel[62] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 76
		headModel[63] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 77
		headModel[64] = new ModelRendererTurbo(this, 3, 1, textureX, textureY); // Box 78
		headModel[65] = new ModelRendererTurbo(this, 3, 1, textureX, textureY); // Box 79
		headModel[66] = new ModelRendererTurbo(this, 3, 1, textureX, textureY); // Box 80
		headModel[67] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 81
		headModel[68] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 82
		headModel[69] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 83
		headModel[70] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 84
		headModel[71] = new ModelRendererTurbo(this, 73, 33, textureX, textureY); // Box 85
		headModel[72] = new ModelRendererTurbo(this, 49, 17, textureX, textureY); // Box 86
		headModel[73] = new ModelRendererTurbo(this, 73, 17, textureX, textureY); // Box 87
		headModel[74] = new ModelRendererTurbo(this, 9, 1, textureX, textureY); // Box 88
		headModel[75] = new ModelRendererTurbo(this, 97, 17, textureX, textureY); // Box 89
		headModel[76] = new ModelRendererTurbo(this, 105, 17, textureX, textureY); // Box 90
		headModel[77] = new ModelRendererTurbo(this, 121, 17, textureX, textureY); // Box 91
		headModel[78] = new ModelRendererTurbo(this, 1, 25, textureX, textureY); // Box 92
		headModel[79] = new ModelRendererTurbo(this, 49, 25, textureX, textureY); // Box 93
		headModel[80] = new ModelRendererTurbo(this, 97, 33, textureX, textureY); // Box 94
		headModel[81] = new ModelRendererTurbo(this, 121, 25, textureX, textureY); // Box 95
		headModel[82] = new ModelRendererTurbo(this, 113, 33, textureX, textureY); // Box 96
		headModel[83] = new ModelRendererTurbo(this, 33, 41, textureX, textureY); // Box 97
		...
		headModel[57].addShapeBox(4.8F, -8.49F, 0.5F, 1, 5, 1, 0F,-0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.7F, 0F, -0.2F, -0.7F, 0F); // Box 57
		headModel[57].setRotationPoint(0F, 0F, 0F);

		headModel[58].addShapeBox(4.8F, -5.5F, -0.5F, 1, 2, 1, 0F,-0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.7F, 0F, -0.2F, -0.7F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F); // Box 58
		headModel[58].setRotationPoint(0F, 0F, 0F);

		headModel[59].addShapeBox(4.8F, -8.5F, -0.5F, 1, 3, 1, 0F,-0.2F, 0F, 2F, -0.2F, 0F, 2F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F); // Box 59
		headModel[59].setRotationPoint(0F, 0F, 0F);

		headModel[60].addShapeBox(4.8F, -10.49F, -2.5F, 1, 2, 4, 0F,0.3F, 0.8F, 0.8F, -0.7F, 0.8F, 0.8F, -0.7F, 0.5F, 0.5F, 0.3F, 0.5F, 0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F); // Box 60
		headModel[60].setRotationPoint(0F, 0F, 0F);

		headModel[61].addShapeBox(-0.5F, -7F, -5.8F, 1, 3, 1, 0F,-0.48F, -0.5F, -0.5F, -0.48F, -0.5F, -0.5F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.48F, 0F, 0.1F, -0.48F, 0F, 0.1F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 75
		headModel[61].setRotationPoint(0F, 0F, 0F);

		headModel[62].addShapeBox(-0.5F, -9.01F, -4.7F, 1, 3, 1, 0F,-0.48F, -0.7F, -0.6F, -0.48F, -0.7F, -0.6F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, -0.48F, -0.5F, 0.6F, -0.48F, -0.5F, 0.6F, 0F, -0.5F, -1F, 0F, -0.5F, -1F); // Box 76
		headModel[62].setRotationPoint(0F, 0F, 0F);

		headModel[63].addShapeBox(-0.5F, -10.3F, -1.8F, 1, 1, 1, 0F,-0.48F, 0F, -0.5F, -0.48F, 0F, -0.5F, 0F, -0.5F, 0.5F, 0F, -0.5F, 0.5F, -0.48F, 1F, 2.3F, -0.48F, 1F, 2.3F, 0F, 1F, -2.9F, 0F, 1F, -2.9F); // Box 77
		headModel[63].setRotationPoint(0F, 0F, 0F);

		headModel[64].addShapeBox(-0.5F, -10.8F, -1.3F, 1, 1, 1, 0F,-0.48F, -0.49F, 0F, -0.48F, -0.49F, 0F, -0.48F, 0F, 0F, -0.48F, 0F, 0F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 78
		headModel[64].setRotationPoint(0F, 0F, 0F);

		headModel[65].addShapeBox(-0.5F, -10.8F, 0F, 1, 1, 3, 0F,-0.48F, 0F, 0.29F, -0.48F, 0F, 0.29F, -0.48F, 0F, 0F, -0.48F, 0F, 0F, 0F, 0F, 0.29F, 0F, 0F, 0.29F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 79
		headModel[65].setRotationPoint(0F, 0F, 0F);

		headModel[66].addShapeBox(-0.5F, -10.8F, 3F, 1, 1, 1, 0F,-0.48F, 0F, 0F, -0.48F, 0F, 0F, -0.48F, -0.49F, 0F, -0.48F, -0.49F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, -0.5F, 0F, 0F, -0.5F); // Box 80
		headModel[66].setRotationPoint(0F, 0F, 0F);

		headModel[67].addShapeBox(-0.5F, -11.31F, 4.9F, 1, 3, 1, 0F,0F, -1.5F, 2F, 0F, -1.5F, 2F, -0.48F, -1F, -1.9F, -0.48F, -1F, -1.9F, 0F, 0F, 0F, 0F, 0F, 0F, -0.48F, 0F, -0.6F, -0.48F, 0F, -0.6F); // Box 81
		headModel[67].setRotationPoint(0F, 0F, 0F);

		headModel[68].addShapeBox(-0.5F, -9F, 4.9F, 1, 3, 1, 0F,0F, -0.7F, 0F, 0F, -0.7F, 0F, -0.48F, -0.7F, -0.6F, -0.48F, -0.7F, -0.6F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.48F, -0.5F, 0.1F, -0.48F, -0.5F, 0.1F); // Box 82
		headModel[68].setRotationPoint(0F, 0F, 0F);

		headModel[69].addShapeBox(-0.5F, -7.01F, 4.9F, 1, 3, 1, 0F,0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.48F, -0.5F, 0.1F, -0.48F, -0.5F, 0.1F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, -0.48F, 0F, 0.1F, -0.48F, 0F, 0.1F); // Box 83
		headModel[69].setRotationPoint(0F, 0F, 0F);

		headModel[70].addShapeBox(-0.5F, -4.5F, 4.9F, 1, 3, 1, 0F,0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, -0.48F, -0.5F, 0.1F, -0.48F, -0.5F, 0.1F, 0F, 1.5F, 1F, 0F, 1.5F, 1F, -0.48F, 1.5F, -1.5F, -0.48F, 1.5F, -1.5F); // Box 84
		headModel[70].setRotationPoint(0F, 0F, 0F);

		headModel[71].addShapeBox(0.3F, -11.69F, -3.3F, 5, 1, 3, 0F,0.3F, 2F, 0.5F, -1.25F, 0.5F, -0.2F, -1.25F, 0.8F, -0.7F, 0.3F, 2.5F, -1F, 0.3F, 0F, 1.2F, -0.25F, -0.6F, 0F, -0.25F, -0.4F, -0.7F, 0.3F, -1.25F, -0.8F); // Box 85
		headModel[71].setRotationPoint(0F, 0F, 0F);

		headModel[72].addShapeBox(0.3F, -11.7F, -1F, 5, 1, 1, 0F,0.3F, 1.75F, 0.3F, -1.25F, 0F, 0F, -1.25F, 0F, -0.7F, 0.3F, 0.75F, -0.8F, 0.3F, -1.25F, 0.2F, -0.25F, -0.4F, 0F, -0.25F, -0.4F, -0.7F, 0.3F, -1.25F, -0.8F); // Box 86
		headModel[72].setRotationPoint(0F, 0F, 0F);

		headModel[73].addShapeBox(0.3F, -11.7F, 0.1F, 5, 1, 2, 0F,0.3F, 0.7F, 0F, -1.25F, 0F, 0.2F, -1.25F, -0.25F, 0F, 0.3F, -0.25F, 0.5F, 0.3F, -1.25F, 0F, -0.25F, -0.4F, 0.2F, -0.25F, -0.25F, 0F, 0.3F, -0.25F, 0.5F); // Box 87
		headModel[73].setRotationPoint(0F, 0F, 0F);

		headModel[74].addShapeBox(-0.5F, -12.19F, -0.8F, 1, 1, 1, 0F,-0.3F, 1F, 0.4F, -0.3F, 1F, 0.4F, -0.3F, 0F, 0F, -0.3F, 0F, 0F, -0.3F, -0.8F, 0F, -0.3F, -0.8F, 0F, -0.3F, -0.5F, 0F, -0.3F, -0.5F, 0F); // Box 88
		headModel[74].setRotationPoint(0F, 0F, 0F);

		headModel[75].addShapeBox(3.3F, -11.7F, -0.95F, 2, 1, 1, 0F,0.3F, 0.2F, -0.2F, -1.25F, 0F, -0.3F, -1.25F, 0F, -0.2F, 0.3F, 0.2F, -0.1F, 0.3F, 0F, -0.3F, -0.25F, -0.4F, -0.3F, -0.25F, -0.4F, -0.2F, 0.3F, 0F, -0.2F); // Box 89
		headModel[75].setRotationPoint(0F, 0F, 0F);

		headModel[76].addShapeBox(-5.7F, -5.5F, -0.5F, 1, 2, 1, 0F,-0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.7F, 0F, -0.2F, -0.7F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F); // Box 90
		headModel[76].setRotationPoint(0F, 0F, 0F);

		headModel[77].addShapeBox(-5.7F, -8.49F, 0.5F, 1, 5, 1, 0F,-0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, -0.7F, 0F, -0.2F, -0.7F, 0F); // Box 91
		headModel[77].setRotationPoint(0F, 0F, 0F);

		headModel[78].addShapeBox(-5.7F, -8.5F, -0.5F, 1, 3, 1, 0F,-0.2F, 0F, 2F, -0.2F, 0F, 2F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F); // Box 92
		headModel[78].setRotationPoint(0F, 0F, 0F);

		headModel[79].addShapeBox(-5.7F, -10.49F, -2.5F, 1, 2, 4, 0F,-0.7F, 0.8F, 0.8F, 0.3F, 0.8F, 0.8F, 0.3F, 0.5F, 0.5F, -0.7F, 0.5F, 0.5F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F); // Box 93
		headModel[79].setRotationPoint(0F, 0F, 0F);

		headModel[80].addShapeBox(-5.3F, -11.7F, 0.1F, 5, 1, 2, 0F,-1.25F, 0F, 0.2F, 0.3F, 0.7F, 0F, 0.3F, -0.25F, 0.5F, -1.25F, -0.25F, 0F, -0.25F, -0.4F, 0.2F, 0.3F, -1.25F, 0F, 0.3F, -0.25F, 0.5F, -0.25F, -0.25F, 0F); // Box 94
		headModel[80].setRotationPoint(0F, 0F, 0F);

		headModel[81].addShapeBox(-5.3F, -11.7F, -0.95F, 2, 1, 1, 0F,-1.25F, 0F, -0.3F, 0.3F, 0.2F, -0.2F, 0.3F, 0.2F, -0.1F, -1.25F, 0F, -0.2F, -0.25F, -0.4F, -0.3F, 0.3F, 0F, -0.3F, 0.3F, 0F, -0.2F, -0.25F, -0.4F, -0.2F); // Box 95
		headModel[81].setRotationPoint(0F, 0F, 0F);

		headModel[82].addShapeBox(-5.3F, -11.7F, -1F, 5, 1, 1, 0F,-1.25F, 0F, 0F, 0.3F, 1.75F, 0.3F, 0.3F, 0.75F, -0.8F, -1.25F, 0F, -0.7F, -0.25F, -0.4F, 0F, 0.3F, -1.25F, 0.2F, 0.3F, -1.25F, -0.8F, -0.25F, -0.4F, -0.7F); // Box 96
		headModel[82].setRotationPoint(0F, 0F, 0F);

		headModel[83].addShapeBox(-5.3F, -11.69F, -3.3F, 5, 1, 3, 0F,-1.25F, 0.5F, -0.2F, 0.3F, 2F, 0.5F, 0.3F, 2.5F, -1F, -1.25F, 0.8F, -0.7F, -0.25F, -0.6F, 0F, 0.3F, 0F, 1.2F, 0.3F, -1.25F, -0.8F, -0.25F, -0.4F, -0.7F); // Box 97
