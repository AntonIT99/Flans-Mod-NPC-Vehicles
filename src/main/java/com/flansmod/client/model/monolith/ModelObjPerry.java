...
public class ModelObjPerry extends ModelVehicle //Same as Filename
{
	int textureX = 1024;
	int textureY = 1024;

	public ModelObjPerry() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		bodyModel[0] = new ModelRendererTurbo(this, 444, 174, textureX, textureY); // Core1
  		...
  		bodyModel[0].addObj("/Tyrants and Plebeians/assets/flansmod/models/OHP2.obj");
