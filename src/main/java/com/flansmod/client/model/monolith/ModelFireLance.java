...
public class ModelFireLance extends ModelGun //Same as Filename
{
	int textureX = 256;
	int textureY = 32;

	public ModelFireLance() //Same as Filename
	{
	...
	private void initgunModel_1()
	{
		...
		gunModel[4].addBox(-31F, -2F, -2F, 20, 3, 3, 0F); // Box 4
		gunModel[4].setRotationPoint(86F, 0F, 0F);
	}
}