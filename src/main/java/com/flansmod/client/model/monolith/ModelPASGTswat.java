...
public class ModelPASGTswat extends ModelCustomArmour //Same as Filename
{
	int textureX = 64;
	int textureY = 128;

	public ModelPASGTswat() //Same as Filename
	{
	...
	private void initheadModel_1()
	{
		...
		headModel[32] = new ModelRendererTurbo(this, 25, 33, textureX, textureY); // Box 0
		headModel[33] = new ModelRendererTurbo(this, 41, 33, textureX, textureY); // Box 1
		headModel[34] = new ModelRendererTurbo(this, 25, 65, textureX, textureY); // Box 2
		headModel[35] = new ModelRendererTurbo(this, 49, 57, textureX, textureY); // Box 3
		headModel[36] = new ModelRendererTurbo(this, 33, 65, textureX, textureY); // Box 4
		headModel[37] = new ModelRendererTurbo(this, 1, 73, textureX, textureY); // Box 5
		headModel[38] = new ModelRendererTurbo(this, 57, 33, textureX, textureY); // Box 6
		headModel[39] = new ModelRendererTurbo(this, 9, 41, textureX, textureY); // Box 7
		headModel[40] = new ModelRendererTurbo(this, 17, 73, textureX, textureY); // Box 8
		headModel[41] = new ModelRendererTurbo(this, 17, 73, textureX, textureY); // Box 9
		headModel[42] = new ModelRendererTurbo(this, 33, 73, textureX, textureY); // Box 10
		...
		headModel[32].addShapeBox(5.55F, -4.3F, -0.1F, 1, 1, 1, 0F,0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F); // Box 0
		headModel[32].setRotationPoint(0F, 0F, 0F);

		headModel[33].addShapeBox(5.4F, -4.2F, -0.399999999999999F, 1, 1, 1, 0F,-0.5F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.7F, 1F, 0F, -0.7F, 1F, 0F, 0.3F, -1.5F, -0.5F, 0.3F, -1.5F); // Box 1
		headModel[33].setRotationPoint(0F, 0F, 0F);

		headModel[34].addShapeBox(5.4F, -3.9F, -1.4F, 1, 2, 1, 0F,-0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 1F, 0.2F, 0F, 1F, 0.2F, 0F, 0.7F, -0.4F, -0.5F, 0.7F, -0.4F); // Box 2
		headModel[34].setRotationPoint(0F, 0F, 0F);

		headModel[35].addShapeBox(5.6F, -3.9F, -6.1F, 1, 3, 5, 0F,0.65F, 0.5F, -0.2F, -1.35F, 0.5F, -0.5F, -0.35F, 0F, -0.2F, -0.35F, 0F, -0.2F, 0.65F, 2F, -0.2F, -1.35F, 2F, -0.5F, -0.35F, 0.3F, -0.2F, -0.35F, 0.3F, -0.2F); // Box 3
		headModel[35].setRotationPoint(0F, 0F, 0F);

		headModel[36].addShapeBox(2F, -3.9F, -6.25F, 3, 5, 1, 0F,0F, 0.5F, 0.65F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -1.35F, 0F, 0.5F, 0.65F, 0F, 0F, -0.35F, 0F, 0F, -0.35F, 0F, 0.5F, -1.35F); // Box 4
		headModel[36].setRotationPoint(0F, 0F, 0F);

		headModel[37].addShapeBox(-2F, -3.9F, -7.25F, 4, 5, 1, 0F,0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F, 0F, 0.5F, -0.35F); // Box 5
		headModel[37].setRotationPoint(0F, 0F, 0F);

		headModel[38].addShapeBox(-6.55F, -4.3F, -0.1F, 1, 1, 1, 0F,0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F, 0F, 0.1F, 0.1F); // Box 6
		headModel[38].setRotationPoint(0F, 0F, 0F);

		headModel[39].addShapeBox(-6.4F, -4.2F, -0.4F, 1, 1, 1, 0F,0F, 0F, -0.2F, -0.5F, 0F, -0.2F, -0.5F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.7F, 1F, -0.5F, -0.7F, 1F, -0.5F, 0.3F, -1.5F, 0F, 0.3F, -1.5F); // Box 7
		headModel[39].setRotationPoint(0F, 0F, 0F);

		headModel[40].addShapeBox(-6.4F, -3.9F, -1.4F, 1, 2, 1, 0F,0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0.2F, -0.5F, 1F, 0.2F, -0.5F, 0.7F, -0.4F, 0F, 0.7F, -0.4F); // Box 8
		headModel[40].setRotationPoint(0F, 0F, 0F);

		headModel[41].addShapeBox(-6.4F, -3.9F, -6.1F, 1, 3, 5, 0F,-1.35F, 0.5F, -0.5F, 0.65F, 0.5F, -0.2F, -0.35F, 0F, -0.2F, -0.35F, 0F, -0.2F, -1.35F, 2F, -0.5F, 0.65F, 2F, -0.2F, -0.35F, 0.3F, -0.2F, -0.35F, 0.3F, -0.2F); // Box 9
		headModel[41].setRotationPoint(0F, 0F, 0F);

		headModel[42].addShapeBox(-5F, -3.9F, -6.25F, 3, 5, 1, 0F,0F, 0.5F, -0.35F, 0F, 0.5F, 0.65F, 0F, 0.5F, -1.35F, 0F, 0.5F, -0.35F, 0F, 0F, -0.35F, 0F, 0.5F, 0.65F, 0F, 0.5F, -1.35F, 0F, 0F, -0.35F); // Box 10
