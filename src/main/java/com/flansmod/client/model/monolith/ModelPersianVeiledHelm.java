...
public class ModelPersianVeiledHelm extends ModelCustomArmour //Same as Filename
{
	int textureX = 128;
	int textureY = 64;

	public ModelPersianVeiledHelm() //Same as Filename
	{
	...
	private void initheadModel_1()
	{
		...
		headModel[5] = new ModelRendererTurbo(this, 41, 1, textureX, textureY); // Box 19
		...
		headModel[8] = new ModelRendererTurbo(this, 73, 1, textureX, textureY); // Box 22
		headModel[9] = new ModelRendererTurbo(this, 81, 1, textureX, textureY); // Box 23
		headModel[10] = new ModelRendererTurbo(this, 25, 9, textureX, textureY); // Box 24
		headModel[11] = new ModelRendererTurbo(this, 97, 1, textureX, textureY); // Box 26
		headModel[12] = new ModelRendererTurbo(this, 105, 1, textureX, textureY); // Box 27
		headModel[13] = new ModelRendererTurbo(this, 121, 1, textureX, textureY); // Box 28
		headModel[14] = new ModelRendererTurbo(this, 49, 17, textureX, textureY); // Box 29
		headModel[15] = new ModelRendererTurbo(this, 73, 17, textureX, textureY); // Box 30
		...
		headModel[18] = new ModelRendererTurbo(this, 97, 17, textureX, textureY); // Box 33
		...
		headModel[21] = new ModelRendererTurbo(this, 113, 17, textureX, textureY); // Box 36
		headModel[22] = new ModelRendererTurbo(this, 81, 25, textureX, textureY); // Box 37
		headModel[23] = new ModelRendererTurbo(this, 97, 17, textureX, textureY); // Box 39
		headModel[24] = new ModelRendererTurbo(this, 1, 33, textureX, textureY); // Box 40
		headModel[25] = new ModelRendererTurbo(this, 17, 33, textureX, textureY); // Box 41
		headModel[26] = new ModelRendererTurbo(this, 33, 33, textureX, textureY); // Box 42
		headModel[27] = new ModelRendererTurbo(this, 49, 33, textureX, textureY); // Box 43
		headModel[28] = new ModelRendererTurbo(this, 65, 33, textureX, textureY); // Box 44
		headModel[29] = new ModelRendererTurbo(this, 81, 33, textureX, textureY); // Box 45
		headModel[30] = new ModelRendererTurbo(this, 97, 33, textureX, textureY); // Box 46
		headModel[31] = new ModelRendererTurbo(this, 113, 33, textureX, textureY); // Box 47
		headModel[32] = new ModelRendererTurbo(this, 1, 41, textureX, textureY); // Box 48
		headModel[33] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Box 49
		headModel[34] = new ModelRendererTurbo(this, 121, 17, textureX, textureY); // Box 50
		headModel[35] = new ModelRendererTurbo(this, 121, 25, textureX, textureY); // Box 51
		headModel[36] = new ModelRendererTurbo(this, 89, 25, textureX, textureY); // Box 52
		headModel[37] = new ModelRendererTurbo(this, 17, 41, textureX, textureY); // Box 53
		headModel[38] = new ModelRendererTurbo(this, 25, 41, textureX, textureY); // Box 54
		headModel[39] = new ModelRendererTurbo(this, 33, 41, textureX, textureY); // Box 55
		...
		headModel[3].addShapeBox(-1F, -4.7F, -4.5F, 2, 1, 1, 0F,0.5F, -0.2F, 0.7F, 0.5F, -0.2F, 0.7F, 0.5F, -0.2F, -0.7F, 0.5F, -0.2F, -0.7F, 0F, 0F, 0.7F, 0F, 0F, 0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.7F); // Box 17
		...
		headModel[5].addShapeBox(-4F, -4.7F, -4.5F, 1, 1, 1, 0F,0.5F, -0.2F, 0.7F, 0.5F, -0.4F, 0.7F, 0.5F, -0.4F, -0.7F, 0.5F, -0.2F, -0.7F, -0.3F, 0F, 0.7F, 0F, 0F, 0.7F, 0F, 0F, -0.7F, -0.3F, 0F, -0.7F); // Box 19
		...
		headModel[9].addShapeBox(3F, -4.7F, -4.5F, 1, 1, 1, 0F,0.5F, -0.4F, 0.7F, 0.5F, -0.2F, 0.7F, 0.5F, -0.2F, -0.7F, 0.5F, -0.4F, -0.7F, 0F, 0F, 0.7F, -0.3F, 0F, 0.7F, -0.3F, 0F, -0.7F, 0F, 0F, -0.7F); // Box 23
		...
		headModel[33].addShapeBox(-0.5F, -10.8F, -0.5F, 1, 1, 1, 0F,0.3F, 0.3F, 0.3F, 0.2F, 0.3F, 0.2F, 0.2F, 0.3F, 0.2F, 0.3F, 0.3F, 0.3F, 0.3F, 0F, 0.3F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.3F, 0F, 0.3F); // Box 49
		headModel[33].setRotationPoint(0F, 0F, 0F);

		headModel[34].addShapeBox(-0.5F, -11.8F, -0.5F, 1, 1, 1, 0F,0.3F, 0.5F, -0.7F, 0.3F, 0.5F, -0.7F, 0.3F, -0.3F, 1.3F, 0.3F, -0.3F, 1.3F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 50
		headModel[34].setRotationPoint(0F, 0F, 0F);

		headModel[35].addShapeBox(-0.5F, -12.5F, 0.5F, 1, 1, 2, 0F,0.3F, -0.2F, 0.3F, 0.3F, -0.2F, 0.3F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F); // Box 51
		headModel[35].setRotationPoint(0F, 0F, 0F);

		headModel[36].addShapeBox(-0.5F, -11.8F, 2.5F, 1, 1, 1, 0F,0.3F, -0.3F, 1.3F, 0.3F, -0.3F, 1.3F, 0.3F, 0.8F, -1F, 0.3F, 0.8F, -1F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, -1F, 0F, 0.5F, -1F, 0F); // Box 52
		headModel[36].setRotationPoint(0F, 0F, 0F);

		headModel[37].addShapeBox(-0.5F, -11.8F, 2.5F, 1, 3, 1, 0F,0.5F, -0.5F, 0.5F, 0.5F, -0.5F, 0.5F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.8F, 0F, -2F, 0.8F, 0F, -2F, 0.8F, 0F, 2.5F, 0.8F, 0F, 2.5F); // Box 53
		headModel[37].setRotationPoint(0F, 0F, 0F);

		headModel[38].addShapeBox(-0.5F, -8.8F, 4.5F, 1, 3, 1, 0F,0.8F, 0F, 0F, 0.8F, 0F, 0F, 0.8F, 0F, 0.5F, 0.8F, 0F, 0.5F, 0.9F, 0.3F, -1F, 0.9F, 0.3F, -1F, 0.9F, 0F, 1.5F, 0.9F, 0F, 1.5F); // Box 54
		headModel[38].setRotationPoint(0F, 0F, 0F);

		headModel[39].addShapeBox(-0.5F, -5.8F, 5.5F, 1, 4, 1, 0F,0.8F, 0F, 0F, 0.8F, 0F, 0F, 0.8F, 0F, 0.5F, 0.8F, 0F, 0.5F, 0.2F, 0.3F, 0F, 0.2F, 0.3F, 0F, 0.2F, 0F, 0.5F, 0.2F, 0F, 0.5F); // Box 55
