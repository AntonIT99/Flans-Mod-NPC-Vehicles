...
public class ModelObjHalifax extends ModelVehicle //Same as Filename
{
	int textureX = 84;
	int textureY = 101;

	public ModelObjHalifax() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		bodyModel[0] = new ModelRendererTurbo(this, 444, 174, textureX, textureY); // Core1
  		...
  		bodyModel[0].addObj("/Tyrants and Plebeians/assets/flansmod/models/Halifax3.obj");
