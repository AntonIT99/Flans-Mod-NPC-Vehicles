...
public class ModelBritbongNapoleonic extends ModelCustomArmour //Same as Filename
{
	int textureX = 128;
	int textureY = 32;

	public ModelBritbongNapoleonic() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5] = new ModelRendererTurbo(this, 97, 17, textureX, textureY); // Box 43
		bodyModel[6] = new ModelRendererTurbo(this, 113, 17, textureX, textureY); // Box 116
		bodyModel[7] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 118
		bodyModel[8] = new ModelRendererTurbo(this, 97, 9, textureX, textureY); // Box 127
		bodyModel[9] = new ModelRendererTurbo(this, 97, 1, textureX, textureY); // Box 128
		bodyModel[10] = new ModelRendererTurbo(this, 44, 1, textureX, textureY); // Box 129
		bodyModel[11] = new ModelRendererTurbo(this, 113, 17, textureX, textureY); // Box 134
		bodyModel[12] = new ModelRendererTurbo(this, 65, 1, textureX, textureY); // Box 135
		bodyModel[13] = new ModelRendererTurbo(this, 97, 17, textureX, textureY); // Box 38
		bodyModel[14] = new ModelRendererTurbo(this, 41, 1, textureX, textureY); // Box 38
		bodyModel[15] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 41
		bodyModel[16] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 48
		bodyModel[17] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 49
		bodyModel[18] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 50
		bodyModel[19] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 51
		bodyModel[20] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 52
		bodyModel[21] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 53
		...
		bodyModel[5].addShapeBox(3F, -0.8F, -1.5F, 2, 2, 3, 0F,0F, 0.2F, 0F, 0.2F, -0.2F, 0F, 0.2F, -0.2F, 0F, 0F, 0.2F, 0F, 0F, 0F, 0F, 0.4F, 0F, 0F, 0.4F, 0F, 0F, 0F, 0F, 0F); // Box 43
		bodyModel[5].setRotationPoint(0F, 0F, 0F);

		bodyModel[6].addShapeBox(0F, 10F, 0F, 4, 4, 2, 0F,-0.5F, -0.25F, 0.8F, 0.7F, -0.1F, 0.8F, 0.7F, -0.1F, 0.8F, 0F, -0.2F, 0.8F, 0.5F, 0.5F, 0.5F, -0.4F, 0.2F, 0.5F, 0F, 0.2F, 1F, 0F, 0.5F, 1.2F); // Box 116
		bodyModel[6].setRotationPoint(0F, 0F, 0F);

		bodyModel[7].addShapeBox(-2F, 0.2F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 118
		bodyModel[7].setRotationPoint(0F, 0F, 0F);

		bodyModel[8].addShapeBox(-4F, 9.5F, -2F, 4, 2, 4, 0F,0.2F, 0F, 0.1F, 0.2F, 0F, 0.1F, 0.2F, 0F, 0.1F, 0.2F, 0F, 0.1F, 0.4F, -0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, 0.2F, 0.2F, 0.4F, -0.2F, 0.2F); // Box 127
		bodyModel[8].setRotationPoint(0F, 0F, 0F);

		bodyModel[9].addShapeBox(-4F, 8F, -2F, 4, 2, 4, 0F,0.3F, 0.2F, 0.5F, 0.5F, 0F, 0.5F, 0F, 0F, 0.5F, 0.3F, 0.2F, 0.5F, 0.7F, 0.1F, 0.8F, 0.5F, 0.25F, 0.8F, 0F, 0.2F, 0.8F, 0.7F, 0.1F, 0.8F); // Box 128
		bodyModel[9].setRotationPoint(0F, 0F, 0F);

		bodyModel[10].addShapeBox(-4F, -0.2F, -2F, 4, 8, 4, 0F,0.7F, 0.1F, 0.4F, 0F, 0.25F, 0.5F, 0F, 0.2F, 0.5F, 0.7F, 0.1F, 0.5F, 0.3F, 0F, 0.5F, 0F, 0.2F, 0.5F, 0F, 0.2F, 0.5F, 0.3F, 0F, 0.5F); // Box 129
		bodyModel[10].setRotationPoint(0F, 0F, 0F);

		bodyModel[11].addShapeBox(-4F, 10F, 0F, 4, 4, 2, 0F,0.7F, -0.1F, 0.8F, -0.5F, -0.25F, 0.8F, 0F, -0.2F, 0.8F, 0.7F, -0.1F, 0.8F, -0.4F, 0.2F, 0.5F, 0.5F, 0.5F, 0.5F, 0F, 0.5F, 1.2F, 0F, 0.2F, 1F); // Box 134
		bodyModel[11].setRotationPoint(0F, 0F, 0F);

		bodyModel[12].addShapeBox(2F, -0.5F, -2.5F, 2, 10, 5, 0F,-0.3F, 0.1F, 0.2F, 0.3F, -0.1F, 0.2F, 0.3F, -0.1F, 0.2F, -0.3F, 0.1F, 0.2F, 6.5F, -2.5F, 0.4F, -8.7F, -0.2F, 0.4F, -8F, 4.8F, 0.8F, 6.5F, 2.8F, 0.8F); // Box 135
		bodyModel[12].setRotationPoint(0F, 0F, 0F);

		bodyModel[13].addShapeBox(-5F, -0.8F, -1.5F, 2, 2, 3, 0F,0.2F, -0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, 0.2F, -0.2F, 0F, 0.4F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.4F, 0F, 0F); // Box 38
		bodyModel[13].setRotationPoint(0F, 0F, 0F);

		bodyModel[14].addShapeBox(-0.5F, 3.1F, -3F, 1, 1, 1, 0F,0.5F, 0F, 0F, -0.5F, 1.2F, 0F, -0.5F, 1.2F, 0F, 0.5F, 0F, 0F, -0.5F, 0.4F, 0F, 0.5F, -1F, 0F, 0.5F, -1F, 0F, -0.5F, 0.4F, 0F); // Box 38
		bodyModel[14].setRotationPoint(0F, 0F, 0F);

		bodyModel[15].addShapeBox(-2F, 1F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 41
		bodyModel[15].setRotationPoint(0F, 0F, 0F);

		bodyModel[16].addShapeBox(-2F, 3.5F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 48
		bodyModel[16].setRotationPoint(0F, 0F, 0F);

		bodyModel[17].addShapeBox(-2F, 2.7F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 49
		bodyModel[17].setRotationPoint(0F, 0F, 0F);

		bodyModel[18].addShapeBox(-2F, 6F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 50
		bodyModel[18].setRotationPoint(0F, 0F, 0F);

		bodyModel[19].addShapeBox(-2F, 5.2F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 51
		bodyModel[19].setRotationPoint(0F, 0F, 0F);

		bodyModel[20].addShapeBox(-2F, 8.5F, -2.7F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 52
		bodyModel[20].setRotationPoint(0F, 0F, 0F);

		bodyModel[21].addShapeBox(-2F, 7.7F, -2.6F, 4, 1, 1, 0F,0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F, 0F, -0.2F, 0F); // Box 53
