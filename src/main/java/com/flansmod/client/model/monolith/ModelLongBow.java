...
public class ModelLongBow extends ModelGun //Same as Filename
{
	int textureX = 64;
	int textureY = 64;

	public ModelLongBow() //Same as Filename
	{
	...
	private void initgunModel_1()
	{
		...
		gunModel[0].addBox(0F, 0F, 0F, 1, 9, 1, 0F); // Box 24
		gunModel[0].setRotationPoint(0F, -10F, 0F);
		gunModel[0].rotateAngleZ = 0.12217305F;

		gunModel[1].addBox(-1F, 0F, 0F, 1, 5, 1, 0F); // Box 25
		gunModel[1].setRotationPoint(-0.2F, 5.7F, 0F);
		gunModel[1].rotateAngleZ = -0.59341195F;

		gunModel[2].addShapeBox(-1F, 5F, 0F, 1, 7, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 1F, 0F, 0F); // Box 26
		gunModel[2].setRotationPoint(-2.5F, 4.5F, 0F);
		gunModel[2].rotateAngleZ = -0.08726646F;

		gunModel[3].addBox(-1F, -12F, 0F, 1, 12, 1, 0F); // Box 27
		gunModel[3].setRotationPoint(1F, -10F, 0F);
		gunModel[3].rotateAngleZ = 0.61086524F;

		gunModel[4].addShapeBox(-3F, -18F, 0F, 1, 5, 1, 0F,-3F, 0F, 0F, 3F, 0F, 0F, 3F, 0F, 0F, -3F, 0F, 0F, -2F, 0F, 0F, 2F, 0F, 0F, 2F, 0F, 0F, -2F, 0F, 0F); // Box 28
		gunModel[4].setRotationPoint(1.6F, -9F, 0F);
		gunModel[4].rotateAngleZ = 0.61086524F;

		gunModel[5].addBox(-1F, 0F, 0F, 1, 7, 1, 0F); // Box 9
		gunModel[5].setRotationPoint(2F, -1F, 0F);
		gunModel[5].rotateAngleZ = -0.31415927F;
	}

	private void initammoModel_1()
	{
		ammoModel[0] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 31
		ammoModel[1] = new ModelRendererTurbo(this, 33, 1, textureX, textureY); // Box 32
		ammoModel[2] = new ModelRendererTurbo(this, 41, 1, textureX, textureY); // Box 33
		...
		ammoModel[0].setRotationPoint(-9F, -2.8F, 0.5F);
		...
		ammoModel[1].setRotationPoint(2F, -2.8F, 0.5F);
		...
		ammoModel[2].setRotationPoint(3F, -2.8F, 0.5F);
	}

	private void initslideModel_1()
	{
		slideModel[0] = new ModelRendererTurbo(this, 25, 9, textureX, textureY); // Box 29
		slideModel[1] = new ModelRendererTurbo(this, 25, 9, textureX, textureY); // Box 10

		slideModel[0].addShapeBox(0F, 0F, 0F, 1, 20, 1, 0F,-0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.3F, -3.3F, 0F, -0.3F, 2.7F, 0F, -0.3F, 2.7F, 0F, -0.3F, -3.3F, 0F, -0.3F); // Box 29
		slideModel[0].setRotationPoint(-7.5F, -23F, 1F);
		...
		slideModel[1].setRotationPoint(-7.5F, -3F, 1F);
