...
public class ModelHouseholdCavalryCuirass extends ModelCustomArmour //Same as Filename
{
	int textureX = 128;
	int textureY = 32;

	public ModelHouseholdCavalryCuirass() //Same as Filename
	{
