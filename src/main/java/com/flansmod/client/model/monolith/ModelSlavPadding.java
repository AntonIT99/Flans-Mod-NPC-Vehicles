...
public class ModelSlavPadding extends ModelCustomArmour //Same as Filename
{
	int textureX = 64;
	int textureY = 128;

	public ModelSlavPadding() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[1].addShapeBox(-4F, 10.3F, -2F, 8, 5, 4, 0F,0.3F, 0.1F, 0.3F, 0.3F, 0.1F, 0.3F, 0.3F, 0.1F, 0.3F, 0.3F, 0.1F, 0.3F, 0.8F, 1.7F, 0.8F, 0.8F, 1.7F, 0.8F, 0.8F, 1.7F, 0.8F, 0.8F, 1.7F, 0.8F); // Box 19
