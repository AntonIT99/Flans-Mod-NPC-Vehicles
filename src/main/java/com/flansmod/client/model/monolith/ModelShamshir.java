...
public class ModelShamshir extends ModelGun //Same as Filename
{
	int textureX = 32;
	int textureY = 32;

	public ModelShamshir() //Same as Filename
	{
	...
	{
		gunModel[0] = new ModelRendererTurbo(this, 9, 1, textureX, textureY); // Box 1
		...
		gunModel[4] = new ModelRendererTurbo(this, 17, 9, textureX, textureY); // Box 8
		gunModel[5] = new ModelRendererTurbo(this, 25, 9, textureX, textureY); // Box 9
		gunModel[6] = new ModelRendererTurbo(this, 1, 17, textureX, textureY); // Box 10
		gunModel[7] = new ModelRendererTurbo(this, 9, 17, textureX, textureY); // Box 11
		gunModel[8] = new ModelRendererTurbo(this, 17, 17, textureX, textureY); // Box 10
		gunModel[9] = new ModelRendererTurbo(this, 25, 17, textureX, textureY); // Box 11
		gunModel[10] = new ModelRendererTurbo(this, 1, 25, textureX, textureY); // Box 12

		gunModel[0].addShapeBox(0F, 0F, -1F, 1, 6, 2, 0F,-0.4F, 0F, -0.3F, -0.4F, 0F, -0.3F, -0.4F, 0F, -0.6F, -0.4F, 0F, -0.6F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F); // Box 1
		gunModel[0].setRotationPoint(0.2F, -9F, 0.5F);
		gunModel[0].rotateAngleY = -1.04719755F;

		gunModel[1].addShapeBox(0F, 0F, -0.7F, 1, 4, 1, 0F,-0.15F, 0.2F, 0.05F, -0.15F, 0.2F, 0.05F, -0.15F, 0.2F, 0.25F, -0.15F, 0.2F, 0.25F, -0.15F, 0.2F, -0.25F, -0.15F, 0.2F, -0.25F, -0.15F, 0.2F, -0.05F, -0.15F, 0.2F, -0.05F); // Box 3
		gunModel[1].setRotationPoint(0.2F, -2F, 0.5F);
		gunModel[1].rotateAngleY = -1.04719755F;

		gunModel[2].addShapeBox(0F, 1F, -0.5F, 1, 1, 1, 0F,-0.15F, -0.2F, -0.05F, -0.15F, -0.2F, -0.05F, -0.15F, 0F, -0.2F, -0.15F, 0F, -0.2F, -0.15F, -0.2F, -1.2F, -0.15F, -0.2F, -1.2F, -0.15F, -0.6F, 0.7F, -0.15F, -0.6F, 0.7F); // Box 4
		...
		gunModel[8].addShapeBox(0F, 0F, -0.65F, 1, 1, 1, 0F,0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, 0F, 0.3F, 0F, -0.2F, -0.45F, 0F, -0.2F, -0.45F, 0F, -0.2F, -0.45F, 0F, -0.2F, -0.45F); // Box 10
		gunModel[8].setRotationPoint(0.2F, -2.2F, 0.5F);
		gunModel[8].rotateAngleY = -1.04719755F;

		gunModel[9].addShapeBox(0F, 0F, -1.15F, 1, 5, 2, 0F,-0.4F, 0F, 0.5F, -0.4F, 0F, 0.5F, -0.4F, 0F, -1.5F, -0.4F, 0F, -1.5F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F); // Box 11
		gunModel[9].setRotationPoint(0.2F, -14.5F, 0.5F);
		gunModel[9].rotateAngleY = -1.04719755F;

		gunModel[10].addShapeBox(0F, -3.5F, -2.2F, 1, 3, 2, 0F,-0.4F, 0F, 1.5F, -0.4F, 0F, 1.5F, -0.4F, -0.5F, -2.8F, -0.4F, -0.5F, -2.8F, -0.4F, 0.5F, -0.5F, -0.4F, 0.5F, -0.5F, -0.4F, 0.5F, -0.45F, -0.4F, 0.5F, -0.45F); // Box 12
		gunModel[10].setRotationPoint(0.2F, -14.5F, 0.5F);
