...
public class ModelGK80helmet extends ModelCustomArmour //Same as Filename
{
	int textureX = 64;
	int textureY = 64;

	public ModelGK80helmet() //Same as Filename
	{
		...
		headModel[6] = new ModelRendererTurbo(this, 25, 17, textureX, textureY); // Box 45
		...
		headModel[11] = new ModelRendererTurbo(this, 17, 33, textureX, textureY); // Box 8
		headModel[12] = new ModelRendererTurbo(this, 17, 17, textureX, textureY); // Box 9
		headModel[13] = new ModelRendererTurbo(this, 57, 1, textureX, textureY); // Box 10
		...
		headModel[20] = new ModelRendererTurbo(this, 1, 49, textureX, textureY); // Box 3
