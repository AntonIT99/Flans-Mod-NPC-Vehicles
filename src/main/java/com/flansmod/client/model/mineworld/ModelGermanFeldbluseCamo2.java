...
public class ModelGermanFeldbluseCamo2 extends ModelCustomArmour //Same as Filename
{
	int textureX = 128;
	int textureY = 256;

	public ModelGermanFeldbluseCamo2() //Same as Filename
	{
		...
		bodyModel[25] = new ModelRendererTurbo(this, 105, 10, textureX, textureY); // Box 42
		bodyModel[26] = new ModelRendererTurbo(this, 105, 10, textureX, textureY); // Box 43
		bodyModel[27] = new ModelRendererTurbo(this, 120, 3, textureX, textureY); // Box 44
		bodyModel[28] = new ModelRendererTurbo(this, 120, 3, textureX, textureY); // Box 45
		bodyModel[29] = new ModelRendererTurbo(this, 117, 10, textureX, textureY); // Box 46
		bodyModel[30] = new ModelRendererTurbo(this, 117, 10, textureX, textureY); // Box 48
		bodyModel[31] = new ModelRendererTurbo(this, 25, 67, textureX, textureY); // Box 50
		bodyModel[32] = new ModelRendererTurbo(this, 25, 67, textureX, textureY); // Box 51
		bodyModel[33] = new ModelRendererTurbo(this, 25, 67, textureX, textureY); // Box 52
		bodyModel[34] = new ModelRendererTurbo(this, 80, 105, textureX, textureY); // Box 52
		bodyModel[35] = new ModelRendererTurbo(this, 96, 3, textureX, textureY); // Box 52
		bodyModel[36] = new ModelRendererTurbo(this, 96, 3, textureX, textureY); // Box 53
		bodyModel[37] = new ModelRendererTurbo(this, 25, 57, textureX, textureY); // Box 52
		bodyModel[38] = new ModelRendererTurbo(this, 25, 57, textureX, textureY); // Box 53
		bodyModel[39] = new ModelRendererTurbo(this, 5, 208, textureX, textureY); // Box 54
		bodyModel[40] = new ModelRendererTurbo(this, 5, 208, textureX, textureY); // Box 55
		bodyModel[41] = new ModelRendererTurbo(this, 5, 208, textureX, textureY); // Box 56
		bodyModel[42] = new ModelRendererTurbo(this, 5, 208, textureX, textureY); // Box 57
		bodyModel[43] = new ModelRendererTurbo(this, 3, 81, textureX, textureY); // Box 51
		bodyModel[44] = new ModelRendererTurbo(this, 3, 81, textureX, textureY); // Box 52
		...
		bodyModel[25].addShapeBox(1F, 8.8F, -2.3F, 2, 3, 1, 0F, 0F, 0.5F, 0F, 1F, 0.5F, 0F, 1F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 42
		bodyModel[25].setRotationPoint(0F, 0F, 0F);

		bodyModel[26].addShapeBox(-4F, 8.8F, -2.3F, 2, 3, 1, 0F, 0F, 0.5F, 0F, 1F, 0.5F, 0F, 1F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 43
		bodyModel[26].setRotationPoint(0F, 0F, 0F);

		bodyModel[27].addShapeBox(-4F, 8.8F, -2.4F, 2, 1, 1, 0F, 0F, 0.5F, 0F, 1F, 0.5F, 0F, 1F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 44
		bodyModel[27].setRotationPoint(0F, 0F, 0F);

		bodyModel[28].addShapeBox(1F, 8.8F, -2.4F, 2, 1, 1, 0F, 0F, 0.5F, 0F, 1F, 0.5F, 0F, 1F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F); // Box 45
		bodyModel[28].setRotationPoint(0F, 0F, 0F);

		bodyModel[29].addShapeBox(-3F, 9.8F, -2.39F, 1, 2, 1, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 46
		bodyModel[29].setRotationPoint(0F, 0F, 0F);

		bodyModel[30].addShapeBox(2F, 9.8F, -2.39F, 1, 2, 1, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 48
		bodyModel[30].setRotationPoint(0F, 0F, 0F);

		bodyModel[31].addShapeBox(-2.3F, 0.05F, -1.69F, 8, 7, 4, 0F, 0.2F, 0.2F, 0.4F, -6.75F, 0.2F, 0.4F, -6.75F, 0.2F, -0.3F, 0.2F, 0.2F, -0.3F, 0.2F, -6.7F, 0.4F, -6.75F, -6.7F, 0.4F, -6.75F, -6.7F, -0.3F, 0.2F, -6.7F, -0.3F); // Box 50
		bodyModel[31].setRotationPoint(0F, 0F, 0F);

		bodyModel[32].addShapeBox(1.25F, 0.05F, -1.69F, 8, 7, 4, 0F, 0.2F, 0.2F, 0.4F, -6.75F, 0.2F, 0.4F, -6.75F, 0.2F, -0.3F, 0.2F, 0.2F, -0.3F, 0.2F, -6.7F, 0.4F, -6.75F, -6.7F, 0.4F, -6.75F, -6.7F, -0.3F, 0.2F, -6.7F, -0.3F); // Box 51
		bodyModel[32].setRotationPoint(0F, 0F, 0F);

		bodyModel[33].addShapeBox(-2.1F, 0.04F, 1.5F, 11, 7, 1, 0F, 0.2F, 0.2F, 0.3F, -6.6F, 0.2F, 0.3F, -6.6F, 0.2F, -0.3F, 0.2F, 0.2F, -0.3F, 0.2F, -6.7F, 0.3F, -6.6F, -6.7F, 0.3F, -6.6F, -6.7F, -0.3F, 0.2F, -6.7F, -0.3F); // Box 52
		bodyModel[33].setRotationPoint(0F, 0F, 0F);

		bodyModel[34].addShapeBox(-11.5F, 0.92F, -2.6F, 12, 6, 6, 0F, -10.43F, 1.07F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -5.5F, -10.43F, 1.07F, -5.5F, -9.75F, -6.352F, 0F, -1.2F, -5.3F, 0F, -1.2F, -5.3F, -5.5F, -9.75F, -6.352F, -5.5F); // Box 52
		bodyModel[34].setRotationPoint(0F, 0F, 0F);

		bodyModel[35].addShapeBox(1.04F, -0.13F, -2.61F, 1, 1, 1, 0F, -1.35F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, -1.35F, 0F, 0F, -0.7F, -0.3F, 0F, -0.5F, -0.5F, 0F, -0.5F, -0.5F, 0F, -0.7F, -0.3F, 0F); // Box 52
		bodyModel[35].setRotationPoint(0F, 0F, 0F);

		bodyModel[36].addShapeBox(-2.44F, -0.13F, -2.6F, 1, 1, 1, 0F, 0F, 0F, 0F, 0.35F, 0F, 0F, 0.35F, 0F, 0F, 0F, 0F, 0F, -0.5F, -0.5F, 0F, -0.3F, -0.3F, 0F, -0.3F, -0.3F, 0F, -0.5F, -0.5F, 0F); // Box 53
		bodyModel[36].setRotationPoint(0F, 0F, 0F);

		bodyModel[37].addShapeBox(-3F, 7F, 2.5F, 6, 2, 2, 0F, 0.0F, 0.4F, 0.2F, 0.0F, -0.8F, 0.2F, 0.0F, -0.8F, 0.2F, 0.0F, 0.4F, 0.2F, -0.25F, -3.2F, -0.8F, 0.25F, -1.8F, -0.8F, 0.25F, -1.8F, -0.8F, -0.25F, -3.2F, -0.8F); // Box 52
		bodyModel[37].setRotationPoint(0F, 0F, 0F);

		bodyModel[38].addShapeBox(-3F, 7F, 2.5F, 6, 2, 2, 0F, 0.75F, -1.6F, -0.8F, -0.75F, -2.8F, -0.8F, -0.75F, -2.8F, -0.8F, 0.75F, 0.4F, -0.8F, 0.5F, -1.2F, 0.2F, -0.5F, 0.2F, 0.2F, -0.5F, 0.2F, 0.2F, 0.5F, -1.2F, 0.2F); // Box 53
		bodyModel[38].setRotationPoint(0F, 0F, 0F);

		bodyModel[39].addShapeBox(-0.83F, 1.8F, -2.5F, 1, 1, 1, 0F, -1.1F, 0.2F, -0.25F, 0.2F, 0.2F, -0.25F, 0.2F, 0.2F, -0.25F, -1.1F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F); // Box 54
		bodyModel[39].setRotationPoint(0F, 0F, 0F);

		bodyModel[40].addShapeBox(-0.17F, 1.8F, -2.5F, 1, 1, 1, 0F, 0.2F, 0.2F, -0.25F, -1.1F, 0.2F, -0.25F, -1.1F, 0.2F, -0.25F, 0.2F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F); // Box 55
		bodyModel[40].setRotationPoint(0F, 0F, 0F);

		bodyModel[41].addShapeBox(-0.17F, 3.5F, -2.5F, 1, 1, 1, 0F, 0.2F, 0.2F, -0.25F, -1.1F, 0.2F, -0.25F, -1.1F, 0.2F, -0.25F, 0.2F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F); // Box 56
		bodyModel[41].setRotationPoint(0F, 0F, 0F);

		bodyModel[42].addShapeBox(-0.83F, 3.5F, -2.5F, 1, 1, 1, 0F, -1.1F, 0.2F, -0.25F, 0.2F, 0.2F, -0.25F, 0.2F, 0.2F, -0.25F, -1.1F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F, -0.5F, 0.2F, -0.25F, -0.4F, 0.2F, -0.25F); // Box 57
		bodyModel[42].setRotationPoint(0F, 0F, 0F);

		bodyModel[43].addShapeBox(-2.75F, 9.5F, -2.66F, 2, 2, 1, 0F, 0F, 0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, -1.5F, -0.25F, -1.5F, -1.5F, -0.25F, -1.5F, -1.5F, -0.25F, 0F, -1.5F, -0.25F); // Box 51
		bodyModel[43].setRotationPoint(0F, 0F, 0F);

		bodyModel[44].addShapeBox(2.25F, 9.5F, -2.66F, 2, 2, 1, 0F, 0F, 0F, -0.25F, -1.5F, 0F, -0.25F, -1.5F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, -1.5F, -0.25F, -1.5F, -1.5F, -0.25F, -1.5F, -1.5F, -0.25F, 0F, -1.5F, -0.25F); // Box 52
