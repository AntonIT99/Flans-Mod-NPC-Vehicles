...
public class ModelGermanFeldbluseFallschirmjaeger extends ModelCustomArmour //Same as Filename
{
	int textureX = 128;
	int textureY = 256;

	public ModelGermanFeldbluseFallschirmjaeger() //Same as Filename
	{
