...
public class EntityshipDeath extends EntityFX
{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        float scale = 0.1F + ((this.particleAge)*25F) - ((this.particleAge)*(this.particleAge)*2F);
        ...
        par1Tessellator.setColorRGBA_F(this.particleRed * colorIntensity, this.particleGreen * (colorIntensity - this.particleAge*0.005F), this.particleBlue * (colorIntensity - this.particleAge*0.5F), (1F - this.particleAge*this.particleAge*this.particleAge*0.0025F));
