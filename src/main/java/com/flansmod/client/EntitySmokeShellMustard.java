...
public class EntitySmokeShellMustard extends EntityFX
{
	...
	public EntitySmokeShellMustard(World w, double px, double py, double pz, double mx, double my, double mz)
	{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        par1Tessellator.setColorRGBA_F(this.particleRed * 8f * colorIntensity, this.particleGreen * 7.7f * colorIntensity, this.particleBlue * 6f * colorIntensity, (1F - this.particleAge*this.particleAge*this.particleAge*0.0000000081F));
