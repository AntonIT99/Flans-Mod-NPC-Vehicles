...
public class EntityFMNuke extends EntityFX
{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        float scale = 40.6F - ((this.particleAge)*15F);
        ...
        par1Tessellator.setColorRGBA_F(this.particleRed * colorIntensity, this.particleGreen * (colorIntensity - this.particleAge*0.05F), this.particleBlue * (colorIntensity - this.particleAge*0.05F), (1F - this.particleAge*0.005F));
