...
public class EntityAPSGrenade extends EntityFX
{
	...
	public EntityAPSGrenade(World w, double px, double py, double pz, double mx, double my, double mz)
	{
		super(w, px, py, pz, mx, my, mz);
		this.particleMaxAge *= 20;
		this.particleGravity = 3;
		this.motionX = mx;
		this.motionY = my;
		this.motionZ = mz;
	...
	public void onUpdate()
	{
		...
		this.motionY -= 0.08D * (double) this.particleGravity;
