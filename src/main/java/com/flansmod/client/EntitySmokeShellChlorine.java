...
public class EntitySmokeShellChlorine extends EntityFX
{
	public int disTime;
	public static ResourceLocation icon = new ResourceLocation("flansmod", "particle/FMSmoke.png");
	public EntitySmokeShellChlorine(World w, double px, double py, double pz, double mx, double my, double mz)
	{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
    	...
    	FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation("flansmod", "particle/FMSmokeChlorine.png"));

        float scale = 15F + (this.particleAge * 0.01F);
        ...
        par1Tessellator.setColorRGBA_F(this.particleRed * colorIntensity * 2.0f, this.particleGreen * colorIntensity * 2.75f, this.particleBlue * colorIntensity * 1.5f, (1F - this.particleAge*this.particleAge*this.particleAge*0.0000000081F));
