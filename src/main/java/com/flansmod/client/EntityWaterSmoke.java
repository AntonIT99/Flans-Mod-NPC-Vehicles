...
public class EntityWaterSmoke extends EntityFX
{
	...
	public EntityWaterSmoke(World w, double px, double py, double pz, double mx, double my, double mz)
	{
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        float scale = 5F + (this.particleAge * 0.01F);
        ...
        par1Tessellator.setColorRGBA_F(this.particleRed * (colorIntensity - this.particleAge*0.05F), this.particleGreen * (colorIntensity - this.particleAge*0.05F), this.particleBlue * (colorIntensity - this.particleAge*0.05F), (1F - this.particleAge*this.particleAge*this.particleAge*0.0000000081F));
