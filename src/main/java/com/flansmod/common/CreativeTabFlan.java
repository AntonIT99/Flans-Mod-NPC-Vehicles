...
public class CreativeTabFlan extends CreativeTabs
{
	...
	public ItemStack getIconItemStack()
	{
		...
		switch(type)
		{
			case 0 : return GunType.gunList.size() == 0 ? new ItemStack(FlansMod.opStick, 1, 5) : new ItemStack(FlansMod.opStick, 1, 5);
			case 1 : return DriveableType.types.size() == 0 ? new ItemStack(FlansMod.opStick, 1, 1) : new ItemStack(FlansMod.opStick, 1, 1);
			case 2 : return FlansMod.partItems.size() == 0 ? new ItemStack(FlansMod.opStick, 1, 3) : new ItemStack(FlansMod.opStick, 1, 3);
			case 3 : return FlansMod.armourItems.size() == 0 ? new ItemStack(FlansMod.opStick, 1, 0) : new ItemStack(FlansMod.opStick, 1, 0);
			case 4 : return FlansMod.mechaItems.size() == 0 ? new ItemStack(FlansMod.opStick, 1, 2) : new ItemStack(FlansMod.opStick, 1, 2);
		}
