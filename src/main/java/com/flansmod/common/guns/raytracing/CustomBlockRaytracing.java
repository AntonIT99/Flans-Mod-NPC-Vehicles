...
//this entire file is baris' original content for glass and grass penetration
    ...
    public static MovingObjectPosition func_147447_a(World w, Vec3 p_147447_1_, Vec3 p_147447_2_, boolean p_147447_3_, boolean p_147447_4_, boolean p_147447_5_)
    {
        if (!Double.isNaN(p_147447_1_.xCoord) && !Double.isNaN(p_147447_1_.yCoord) && !Double.isNaN(p_147447_1_.zCoord))
        {
            if (!Double.isNaN(p_147447_2_.xCoord) && !Double.isNaN(p_147447_2_.yCoord) && !Double.isNaN(p_147447_2_.zCoord))
            {
                ...
                if (!doWeIgnoreThisBlock&&((!p_147447_4_ || block.getCollisionBoundingBoxFromPool(w, l, i1, j1) != null) && block.canCollideCheck(k1, p_147447_3_)))
                {
                    MovingObjectPosition movingobjectposition = block.collisionRayTrace(w, l, i1, j1, p_147447_1_, p_147447_2_);
                ...
                while (k1-- >= 0)
                {
                    ...
                    if(block1 instanceof BlockLeaves||block1 instanceof BlockGlass||block1 instanceof BlockStainedGlass||block1 instanceof BlockStainedGlassPane||block1 instanceof BlockPane) {
                        doWeIgnoreThisBlock= true;
                    }

                    if (!doWeIgnoreThisBlock&&(!p_147447_4_ || block1.getCollisionBoundingBoxFromPool(w, l, i1, j1) != null))
                    {
                        if (block1.canCollideCheck(l1, p_147447_3_))
                        {
                            MovingObjectPosition movingobjectposition1 = block1.collisionRayTrace(w, l, i1, j1, p_147447_1_, p_147447_2_);
