...
public class PacketSeatUpdates extends PacketBase 
{
	...
	public void handleServerSide(EntityPlayerMP playerEntity) 
	{
		...
		if(driveable != null)
		{
            ...
            FlansMod.getPacketHandler().sendToAllAround(this, driveable.posX, driveable.posY, driveable.posZ, FlansMod.driveableUpdateRange, driveable.dimension); //with range buff
